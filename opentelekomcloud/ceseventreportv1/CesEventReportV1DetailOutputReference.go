...
func (c *jsiiProxy_CesEventReportV1DetailOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CesEventReportV1DetailOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
