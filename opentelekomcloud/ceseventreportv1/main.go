...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CesEventReportV1)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.cesEventReportV1.CesEventReportV1Config",
		reflect.TypeOf((*CesEventReportV1Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.cesEventReportV1.CesEventReportV1Detail",
		reflect.TypeOf((*CesEventReportV1Detail)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.cesEventReportV1.CesEventReportV1DetailOutputReference",
		reflect.TypeOf((*CesEventReportV1DetailOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.cesEventReportV1.CesEventReportV1Timeouts",
		reflect.TypeOf((*CesEventReportV1Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.cesEventReportV1.CesEventReportV1TimeoutsOutputReference",
		reflect.TypeOf((*CesEventReportV1TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
