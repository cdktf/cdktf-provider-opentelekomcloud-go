...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WafDedicatedAlarmMaskingRuleV1)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WafDedicatedAlarmMaskingRuleV1AdvancedSettings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.wafDedicatedAlarmMaskingRuleV1.WafDedicatedAlarmMaskingRuleV1AdvancedSettingsList",
		reflect.TypeOf((*WafDedicatedAlarmMaskingRuleV1AdvancedSettingsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WafDedicatedAlarmMaskingRuleV1AdvancedSettingsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WafDedicatedAlarmMaskingRuleV1Conditions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.wafDedicatedAlarmMaskingRuleV1.WafDedicatedAlarmMaskingRuleV1ConditionsList",
		reflect.TypeOf((*WafDedicatedAlarmMaskingRuleV1ConditionsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WafDedicatedAlarmMaskingRuleV1ConditionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
