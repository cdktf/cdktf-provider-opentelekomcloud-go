...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudIdentityProjectV3)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isDomainInput", GoGetter: "IsDomainInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsDomain", GoMethod: "ResetIsDomain"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataOpentelekomcloudIdentityProjectV3Config)(nil)).Elem(),
	)
}
