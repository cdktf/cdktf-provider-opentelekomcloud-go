...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SdrsReplicationAttachV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "replicationId", GoGetter: "ReplicationId"},
			_jsii_.MemberProperty{JsiiProperty: "replicationIdInput", GoGetter: "ReplicationIdInput"},
