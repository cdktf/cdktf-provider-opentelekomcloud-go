...
func (f *jsiiProxy_FgsFunctionV2NetworkControllerOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FgsFunctionV2NetworkControllerOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
