...
func (f *jsiiProxy_FgsFunctionV2FuncMountsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FgsFunctionV2FuncMountsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
