...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudVpcEipV1)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "bandwidthId", GoGetter: "BandwidthId"},
			_jsii_.MemberProperty{JsiiProperty: "bandwidthIdInput", GoGetter: "BandwidthIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBandwidthId", GoMethod: "ResetBandwidthId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataOpentelekomcloudVpcEipV1Config)(nil)).Elem(),
	)
}
