...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigwCustomAuthorizerV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isBodySend", GoGetter: "IsBodySend"},
			_jsii_.MemberProperty{JsiiProperty: "isBodySendInput", GoGetter: "IsBodySendInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsBodySend", GoMethod: "ResetIsBodySend"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigwCustomAuthorizerV2IdentityOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
