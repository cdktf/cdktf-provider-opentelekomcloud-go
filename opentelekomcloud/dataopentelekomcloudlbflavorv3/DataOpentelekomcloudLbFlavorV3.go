...
import (
	...
	"github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v12/dataopentelekomcloudlbflavorv3/internal"
...
func (j *jsiiProxy_DataOpentelekomcloudLbFlavorV3) Count() interface{} {
...
// Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.43/docs/data-sources/lb_flavor_v3 opentelekomcloud_lb_flavor_v3} Data Source.
func NewDataOpentelekomcloudLbFlavorV3(scope constructs.Construct, id *string, config *DataOpentelekomcloudLbFlavorV3Config) DataOpentelekomcloudLbFlavorV3 {
	...
	if err := validateNewDataOpentelekomcloudLbFlavorV3Parameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataOpentelekomcloudLbFlavorV3)SetCount(val interface{}) {
...
func DataOpentelekomcloudLbFlavorV3_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataOpentelekomcloudLbFlavorV3_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataOpentelekomcloudLbFlavorV3_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataOpentelekomcloudLbFlavorV3_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataOpentelekomcloudLbFlavorV3_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataOpentelekomcloudLbFlavorV3_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataOpentelekomcloudLbFlavorV3_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataOpentelekomcloudLbFlavorV3_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataOpentelekomcloudLbFlavorV3) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataOpentelekomcloudLbFlavorV3) ToHclTerraform() interface{} {
	var returns interface{}
