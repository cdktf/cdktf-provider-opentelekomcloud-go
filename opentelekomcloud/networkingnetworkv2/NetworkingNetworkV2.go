...
func NetworkingNetworkV2_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateNetworkingNetworkV2_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NetworkingNetworkV2) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkingNetworkV2) HasResourceMove() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NetworkingNetworkV2) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_NetworkingNetworkV2) MoveFromId(id *string) {
...
func (n *jsiiProxy_NetworkingNetworkV2) MoveTo(moveTarget *string, index interface{}) {
...
func (n *jsiiProxy_NetworkingNetworkV2) MoveToId(id *string) {
...
func (n *jsiiProxy_NetworkingNetworkV2) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NetworkingNetworkV2) ToHclTerraform() interface{} {
	var returns interface{}
