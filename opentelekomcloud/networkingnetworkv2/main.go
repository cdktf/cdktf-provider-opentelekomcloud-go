...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkingNetworkV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetShared", GoMethod: "ResetShared"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sharedInput", GoGetter: "SharedInput"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkingNetworkV2SegmentsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "physicalNetwork", GoGetter: "PhysicalNetwork"},
			_jsii_.MemberProperty{JsiiProperty: "physicalNetworkInput", GoGetter: "PhysicalNetworkInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetNetworkType", GoMethod: "ResetNetworkType"},
			_jsii_.MemberMethod{JsiiMethod: "resetPhysicalNetwork", GoMethod: "ResetPhysicalNetwork"},
			_jsii_.MemberMethod{JsiiMethod: "resetSegmentationId", GoMethod: "ResetSegmentationId"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "segmentationId", GoGetter: "SegmentationId"},
			_jsii_.MemberProperty{JsiiProperty: "segmentationIdInput", GoGetter: "SegmentationIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkingNetworkV2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.networkingNetworkV2.NetworkingNetworkV2TimeoutsOutputReference",
		reflect.TypeOf((*NetworkingNetworkV2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
