...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SwrRepositoryV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "internalPath", GoGetter: "InternalPath"},
			...
			_jsii_.MemberProperty{JsiiProperty: "numImages", GoGetter: "NumImages"},
