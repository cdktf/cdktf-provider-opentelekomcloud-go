...
func (d *jsiiProxy_DisDumpTaskV2ObsDestinationDescriptorList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DisDumpTaskV2ObsDestinationDescriptorList) Resolve(context cdktf.IResolveContext) interface{} {
