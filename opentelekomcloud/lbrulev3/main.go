...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LbRuleV3)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LbRuleV3Conditions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.lbRuleV3.LbRuleV3ConditionsList",
		reflect.TypeOf((*LbRuleV3ConditionsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LbRuleV3ConditionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LbRuleV3Config)(nil)).Elem(),
	)
}
