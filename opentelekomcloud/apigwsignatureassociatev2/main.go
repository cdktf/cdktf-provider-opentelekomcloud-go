...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigwSignatureAssociateV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "publishIds", GoGetter: "PublishIds"},
			_jsii_.MemberProperty{JsiiProperty: "publishIdsInput", GoGetter: "PublishIdsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "signatureIdInput", GoGetter: "SignatureIdInput"},
