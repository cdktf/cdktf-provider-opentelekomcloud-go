...
func (c *jsiiProxy_CfwAclRuleV1SequenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CfwAclRuleV1SequenceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
