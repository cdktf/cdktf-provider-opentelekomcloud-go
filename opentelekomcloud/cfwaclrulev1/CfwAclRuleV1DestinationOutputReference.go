...
func (c *jsiiProxy_CfwAclRuleV1DestinationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CfwAclRuleV1DestinationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
