...
func (c *jsiiProxy_CfwAclRuleV1SourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CfwAclRuleV1SourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
