...
func (d *jsiiProxy_DataOpentelekomcloudCceClusterV3CertificateUsersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataOpentelekomcloudCceClusterV3CertificateUsersList) Resolve(context cdktf.IResolveContext) interface{} {
