...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WafPreciseprotectionRuleV1)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WafPreciseprotectionRuleV1Conditions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.wafPreciseprotectionRuleV1.WafPreciseprotectionRuleV1ConditionsList",
		reflect.TypeOf((*WafPreciseprotectionRuleV1ConditionsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WafPreciseprotectionRuleV1ConditionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "logicInput", GoGetter: "LogicInput"},
