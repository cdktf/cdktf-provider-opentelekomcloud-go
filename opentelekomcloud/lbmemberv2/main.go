...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LbMemberV2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LbMemberV2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.lbMemberV2.LbMemberV2Timeouts",
		reflect.TypeOf((*LbMemberV2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.lbMemberV2.LbMemberV2TimeoutsOutputReference",
		reflect.TypeOf((*LbMemberV2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
