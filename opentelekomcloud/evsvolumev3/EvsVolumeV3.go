...
func (j *jsiiProxy_EvsVolumeV3) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_EvsVolumeV3)SetCount(val interface{}) {
...
func EvsVolumeV3_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEvsVolumeV3_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func EvsVolumeV3_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEvsVolumeV3_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EvsVolumeV3_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEvsVolumeV3_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_EvsVolumeV3) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EvsVolumeV3) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EvsVolumeV3) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EvsVolumeV3) MoveFromId(id *string) {
...
func (e *jsiiProxy_EvsVolumeV3) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_EvsVolumeV3) MoveToId(id *string) {
...
func (e *jsiiProxy_EvsVolumeV3) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EvsVolumeV3) ToHclTerraform() interface{} {
	var returns interface{}
