...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EvsVolumeV3)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "multiattachInput", GoGetter: "MultiattachInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMultiattach", GoMethod: "ResetMultiattach"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*EvsVolumeV3Attachment)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.evsVolumeV3.EvsVolumeV3AttachmentList",
		reflect.TypeOf((*EvsVolumeV3AttachmentList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EvsVolumeV3AttachmentOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*EvsVolumeV3Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.evsVolumeV3.EvsVolumeV3Timeouts",
		reflect.TypeOf((*EvsVolumeV3Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.evsVolumeV3.EvsVolumeV3TimeoutsOutputReference",
		reflect.TypeOf((*EvsVolumeV3TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
