...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudComputeFlavorV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "extraSpecs", GoGetter: "ExtraSpecs"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRxTxFactor", GoMethod: "ResetRxTxFactor"},
			_jsii_.MemberMethod{JsiiMethod: "resetSwap", GoMethod: "ResetSwap"},
			...
			_jsii_.MemberProperty{JsiiProperty: "rxTxFactor", GoGetter: "RxTxFactor"},
			_jsii_.MemberProperty{JsiiProperty: "rxTxFactorInput", GoGetter: "RxTxFactorInput"},
			_jsii_.MemberProperty{JsiiProperty: "swap", GoGetter: "Swap"},
			_jsii_.MemberProperty{JsiiProperty: "swapInput", GoGetter: "SwapInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataOpentelekomcloudComputeFlavorV2Config)(nil)).Elem(),
	)
}
