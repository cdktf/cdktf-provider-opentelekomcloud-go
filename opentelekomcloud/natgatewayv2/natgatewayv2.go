...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NatGatewayV2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NatGatewayV2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.natGatewayV2.NatGatewayV2Timeouts",
		reflect.TypeOf((*NatGatewayV2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.natGatewayV2.NatGatewayV2TimeoutsOutputReference",
		reflect.TypeOf((*NatGatewayV2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
