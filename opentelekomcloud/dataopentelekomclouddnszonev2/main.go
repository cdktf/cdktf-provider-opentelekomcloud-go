...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudDnsZoneV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetZoneType", GoMethod: "ResetZoneType"},
			...
			_jsii_.MemberProperty{JsiiProperty: "zoneTypeInput", GoGetter: "ZoneTypeInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataOpentelekomcloudDnsZoneV2Config)(nil)).Elem(),
	)
}
