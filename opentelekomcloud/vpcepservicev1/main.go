...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpcepServiceV1)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "approvalEnabled", GoGetter: "ApprovalEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "approvalEnabledInput", GoGetter: "ApprovalEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetApprovalEnabled", GoMethod: "ResetApprovalEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tcpProxy", GoGetter: "TcpProxy"},
			_jsii_.MemberProperty{JsiiProperty: "tcpProxyInput", GoGetter: "TcpProxyInput"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpcepServiceV1PortOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VpcepServiceV1Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.vpcepServiceV1.VpcepServiceV1TimeoutsOutputReference",
		reflect.TypeOf((*VpcepServiceV1TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
