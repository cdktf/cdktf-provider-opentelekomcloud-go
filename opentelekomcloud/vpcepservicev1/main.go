...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VpcepServiceV1Connections)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.vpcepServiceV1.VpcepServiceV1ConnectionsList",
		reflect.TypeOf((*VpcepServiceV1ConnectionsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpcepServiceV1ConnectionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
