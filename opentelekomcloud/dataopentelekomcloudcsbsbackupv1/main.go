...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudCsbsBackupV1)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "autoTrigger", GoGetter: "AutoTrigger"},
			_jsii_.MemberProperty{JsiiProperty: "averageSpeed", GoGetter: "AverageSpeed"},
			...
			_jsii_.MemberProperty{JsiiProperty: "backupRecordId", GoGetter: "BackupRecordId"},
			_jsii_.MemberProperty{JsiiProperty: "backupRecordIdInput", GoGetter: "BackupRecordIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBackupName", GoMethod: "ResetBackupName"},
			_jsii_.MemberMethod{JsiiMethod: "resetBackupRecordId", GoMethod: "ResetBackupRecordId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "vmMetadata", GoGetter: "VmMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "volumeBackups", GoGetter: "VolumeBackups"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudCsbsBackupV1TagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataOpentelekomcloudCsbsBackupV1VmMetadata)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.dataOpentelekomcloudCsbsBackupV1.DataOpentelekomcloudCsbsBackupV1VmMetadataList",
		reflect.TypeOf((*DataOpentelekomcloudCsbsBackupV1VmMetadataList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudCsbsBackupV1VmMetadataOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "cloudServiceType", GoGetter: "CloudServiceType"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataOpentelekomcloudCsbsBackupV1VolumeBackups)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.dataOpentelekomcloudCsbsBackupV1.DataOpentelekomcloudCsbsBackupV1VolumeBackupsList",
		reflect.TypeOf((*DataOpentelekomcloudCsbsBackupV1VolumeBackupsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudCsbsBackupV1VolumeBackupsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "averageSpeed", GoGetter: "AverageSpeed"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceVolumeName", GoGetter: "SourceVolumeName"},
			_jsii_.MemberProperty{JsiiProperty: "sourceVolumeSize", GoGetter: "SourceVolumeSize"},
			_jsii_.MemberProperty{JsiiProperty: "spaceSavingRatio", GoGetter: "SpaceSavingRatio"},
			_jsii_.MemberProperty{JsiiProperty: "status", GoGetter: "Status"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
