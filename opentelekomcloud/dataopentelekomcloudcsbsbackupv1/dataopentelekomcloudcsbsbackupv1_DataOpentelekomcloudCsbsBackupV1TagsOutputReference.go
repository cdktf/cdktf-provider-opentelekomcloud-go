...
type DataOpentelekomcloudCsbsBackupV1TagsOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *DataOpentelekomcloudCsbsBackupV1Tags
	SetInternalValue(val *DataOpentelekomcloudCsbsBackupV1Tags)
	Key() *string
	// Experimental.
...
func (j *jsiiProxy_DataOpentelekomcloudCsbsBackupV1TagsOutputReference) InternalValue() *DataOpentelekomcloudCsbsBackupV1Tags {
	var returns *DataOpentelekomcloudCsbsBackupV1Tags
	_jsii_.Get(
		j,
		"internalValue",
		&returns,
...
func (j *jsiiProxy_DataOpentelekomcloudCsbsBackupV1TagsOutputReference)SetInternalValue(val *DataOpentelekomcloudCsbsBackupV1Tags) {
...
func (d *jsiiProxy_DataOpentelekomcloudCsbsBackupV1TagsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataOpentelekomcloudCsbsBackupV1TagsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
