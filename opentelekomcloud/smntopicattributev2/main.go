...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SmnTopicAttributeV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "topicAttribute", GoGetter: "TopicAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "topicAttributeInput", GoGetter: "TopicAttributeInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SmnTopicAttributeV2Config)(nil)).Elem(),
	)
}
