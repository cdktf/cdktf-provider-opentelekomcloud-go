...
// Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.31/docs/resources/ecs_instance_v1 opentelekomcloud_ecs_instance_v1} Resource.
...
func (e *jsiiProxy_EcsInstanceV1) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EcsInstanceV1) MoveFromId(id *string) {
...
func (e *jsiiProxy_EcsInstanceV1) MoveToId(id *string) {
...
func (e *jsiiProxy_EcsInstanceV1) ResetAvailabilityZone() {
	_jsii_.InvokeVoid(
		e,
		"resetAvailabilityZone",
		nil, // no parameters
...
func (e *jsiiProxy_EcsInstanceV1) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EcsInstanceV1) ToHclTerraform() interface{} {
	var returns interface{}
