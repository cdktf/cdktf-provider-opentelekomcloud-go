...
func (e *jsiiProxy_EcsInstanceV1OsSchedulerHintsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EcsInstanceV1OsSchedulerHintsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
