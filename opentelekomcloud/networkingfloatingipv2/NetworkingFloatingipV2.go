...
func (j *jsiiProxy_NetworkingFloatingipV2) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func NewNetworkingFloatingipV2(scope constructs.Construct, id *string, config *NetworkingFloatingipV2Config) NetworkingFloatingipV2 {
	...
	if err := validateNewNetworkingFloatingipV2Parameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_NetworkingFloatingipV2)SetCount(val interface{}) {
...
func NetworkingFloatingipV2_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateNetworkingFloatingipV2_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func NetworkingFloatingipV2_IsConstruct(x interface{}) *bool {
	...
	if err := validateNetworkingFloatingipV2_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func NetworkingFloatingipV2_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateNetworkingFloatingipV2_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func NetworkingFloatingipV2_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateNetworkingFloatingipV2_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (n *jsiiProxy_NetworkingFloatingipV2) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkingFloatingipV2) HasResourceMove() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NetworkingFloatingipV2) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_NetworkingFloatingipV2) MoveFromId(id *string) {
...
func (n *jsiiProxy_NetworkingFloatingipV2) MoveTo(moveTarget *string, index interface{}) {
...
func (n *jsiiProxy_NetworkingFloatingipV2) MoveToId(id *string) {
...
func (n *jsiiProxy_NetworkingFloatingipV2) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NetworkingFloatingipV2) ToHclTerraform() interface{} {
	var returns interface{}
