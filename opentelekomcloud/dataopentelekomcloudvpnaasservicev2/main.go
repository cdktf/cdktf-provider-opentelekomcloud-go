...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudVpnaasServiceV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "externalV4IpInput", GoGetter: "ExternalV4IpInput"},
			_jsii_.MemberProperty{JsiiProperty: "externalV6Ip", GoGetter: "ExternalV6Ip"},
			_jsii_.MemberProperty{JsiiProperty: "externalV6IpInput", GoGetter: "ExternalV6IpInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExternalV4Ip", GoMethod: "ResetExternalV4Ip"},
			_jsii_.MemberMethod{JsiiMethod: "resetExternalV6Ip", GoMethod: "ResetExternalV6Ip"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataOpentelekomcloudVpnaasServiceV2Config)(nil)).Elem(),
	)
}
