...
func (j *jsiiProxy_WafDomainV1) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_WafDomainV1)SetCount(val interface{}) {
...
func WafDomainV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafDomainV1_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func WafDomainV1_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafDomainV1_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafDomainV1_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafDomainV1_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafDomainV1) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafDomainV1) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafDomainV1) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafDomainV1) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafDomainV1) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WafDomainV1) MoveToId(id *string) {
...
func (w *jsiiProxy_WafDomainV1) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafDomainV1) ToHclTerraform() interface{} {
	var returns interface{}
