...
func (j *jsiiProxy_VpcepEndpointV1) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.34/docs/resources/vpcep_endpoint_v1 opentelekomcloud_vpcep_endpoint_v1} Resource.
...
func (j *jsiiProxy_VpcepEndpointV1)SetCount(val interface{}) {
...
func VpcepEndpointV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateVpcepEndpointV1_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VpcepEndpointV1) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VpcepEndpointV1) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VpcepEndpointV1) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (v *jsiiProxy_VpcepEndpointV1) MoveFromId(id *string) {
...
func (v *jsiiProxy_VpcepEndpointV1) MoveTo(moveTarget *string, index interface{}) {
...
func (v *jsiiProxy_VpcepEndpointV1) MoveToId(id *string) {
...
func (v *jsiiProxy_VpcepEndpointV1) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VpcepEndpointV1) ToHclTerraform() interface{} {
	var returns interface{}
