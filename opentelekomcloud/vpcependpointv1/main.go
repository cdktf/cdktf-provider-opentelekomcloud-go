...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpcepEndpointV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableDns", GoGetter: "EnableDns"},
			_jsii_.MemberProperty{JsiiProperty: "enableDnsInput", GoGetter: "EnableDnsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "markerId", GoGetter: "MarkerId"},
			_jsii_.MemberMethod{JsiiMethod: "moveFromId", GoMethod: "MoveFromId"},
			_jsii_.MemberMethod{JsiiMethod: "moveTo", GoMethod: "MoveTo"},
			_jsii_.MemberMethod{JsiiMethod: "moveToId", GoMethod: "MoveToId"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "portIp", GoGetter: "PortIp"},
			_jsii_.MemberProperty{JsiiProperty: "portIpInput", GoGetter: "PortIpInput"},
			_jsii_.MemberProperty{JsiiProperty: "projectId", GoGetter: "ProjectId"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnableDns", GoMethod: "ResetEnableDns"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnableWhitelist", GoMethod: "ResetEnableWhitelist"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPortIp", GoMethod: "ResetPortIp"},
			_jsii_.MemberMethod{JsiiMethod: "resetRouteTables", GoMethod: "ResetRouteTables"},
			...
			_jsii_.MemberProperty{JsiiProperty: "routeTables", GoGetter: "RouteTables"},
			_jsii_.MemberProperty{JsiiProperty: "routeTablesInput", GoGetter: "RouteTablesInput"},
