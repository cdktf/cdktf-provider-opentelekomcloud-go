...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudIdentityTemporaryAkskV3)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.dataOpentelekomcloudIdentityTemporaryAkskV3.DataOpentelekomcloudIdentityTemporaryAkskV3Config",
		reflect.TypeOf((*DataOpentelekomcloudIdentityTemporaryAkskV3Config)(nil)).Elem(),
	)
}
