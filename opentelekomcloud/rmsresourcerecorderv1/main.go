...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RmsResourceRecorderV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "obsChannel", GoGetter: "ObsChannel"},
			_jsii_.MemberProperty{JsiiProperty: "obsChannelInput", GoGetter: "ObsChannelInput"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putObsChannel", GoMethod: "PutObsChannel"},
			_jsii_.MemberMethod{JsiiMethod: "putSelector", GoMethod: "PutSelector"},
			_jsii_.MemberMethod{JsiiMethod: "putSmnChannel", GoMethod: "PutSmnChannel"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetObsChannel", GoMethod: "ResetObsChannel"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetSmnChannel", GoMethod: "ResetSmnChannel"},
			...
			_jsii_.MemberProperty{JsiiProperty: "smnChannel", GoGetter: "SmnChannel"},
			_jsii_.MemberProperty{JsiiProperty: "smnChannelInput", GoGetter: "SmnChannelInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*RmsResourceRecorderV1Selector)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.rmsResourceRecorderV1.RmsResourceRecorderV1SelectorOutputReference",
		reflect.TypeOf((*RmsResourceRecorderV1SelectorOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*RmsResourceRecorderV1SmnChannel)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.rmsResourceRecorderV1.RmsResourceRecorderV1SmnChannelOutputReference",
		reflect.TypeOf((*RmsResourceRecorderV1SmnChannelOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
