...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SdrsProtectedInstanceV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "deleteTargetEip", GoGetter: "DeleteTargetEip"},
			_jsii_.MemberProperty{JsiiProperty: "deleteTargetEipInput", GoGetter: "DeleteTargetEipInput"},
			_jsii_.MemberProperty{JsiiProperty: "deleteTargetServer", GoGetter: "DeleteTargetServer"},
			_jsii_.MemberProperty{JsiiProperty: "deleteTargetServerInput", GoGetter: "DeleteTargetServerInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "priorityStation", GoGetter: "PriorityStation"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetDeleteTargetEip", GoMethod: "ResetDeleteTargetEip"},
			_jsii_.MemberMethod{JsiiMethod: "resetDeleteTargetServer", GoMethod: "ResetDeleteTargetServer"},
