...
func (n *jsiiProxy_NetworkingPortV2FixedIpOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkingPortV2FixedIpOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
