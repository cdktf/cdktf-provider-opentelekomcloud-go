...
// Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.46/docs/resources/networking_port_v2 opentelekomcloud_networking_port_v2} Resource.
...
func NetworkingPortV2_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateNetworkingPortV2_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NetworkingPortV2) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkingPortV2) HasResourceMove() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NetworkingPortV2) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_NetworkingPortV2) MoveFromId(id *string) {
...
func (n *jsiiProxy_NetworkingPortV2) MoveTo(moveTarget *string, index interface{}) {
...
func (n *jsiiProxy_NetworkingPortV2) MoveToId(id *string) {
...
func (n *jsiiProxy_NetworkingPortV2) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NetworkingPortV2) ToHclTerraform() interface{} {
	var returns interface{}
