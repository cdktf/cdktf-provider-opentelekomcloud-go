...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigwGatewayRoutesV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nexthops", GoGetter: "Nexthops"},
			_jsii_.MemberProperty{JsiiProperty: "nexthopsInput", GoGetter: "NexthopsInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ApigwGatewayRoutesV2Config)(nil)).Elem(),
	)
}
