...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudDcsMaintainwindowV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBegin", GoMethod: "ResetBegin"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSeq", GoMethod: "ResetSeq"},
			_jsii_.MemberProperty{JsiiProperty: "seq", GoGetter: "Seq"},
			_jsii_.MemberProperty{JsiiProperty: "seqInput", GoGetter: "SeqInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataOpentelekomcloudDcsMaintainwindowV1Config)(nil)).Elem(),
	)
}
