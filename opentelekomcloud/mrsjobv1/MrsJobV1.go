...
func MrsJobV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMrsJobV1_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MrsJobV1) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MrsJobV1) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MrsJobV1) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MrsJobV1) MoveFromId(id *string) {
...
func (m *jsiiProxy_MrsJobV1) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MrsJobV1) MoveToId(id *string) {
...
func (m *jsiiProxy_MrsJobV1) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MrsJobV1) ToHclTerraform() interface{} {
	var returns interface{}
