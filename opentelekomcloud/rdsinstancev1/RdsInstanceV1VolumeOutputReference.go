...
func (r *jsiiProxy_RdsInstanceV1VolumeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RdsInstanceV1VolumeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
