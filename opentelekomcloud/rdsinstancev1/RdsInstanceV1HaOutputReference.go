...
func (r *jsiiProxy_RdsInstanceV1HaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RdsInstanceV1HaOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
