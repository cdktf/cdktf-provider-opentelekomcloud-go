...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigwCertificateV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "effectedAt", GoGetter: "EffectedAt"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTrustedRootCa", GoMethod: "ResetTrustedRootCa"},
			...
			_jsii_.MemberProperty{JsiiProperty: "trustedRootCa", GoGetter: "TrustedRootCa"},
			_jsii_.MemberProperty{JsiiProperty: "trustedRootCaInput", GoGetter: "TrustedRootCaInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ApigwCertificateV2Config)(nil)).Elem(),
	)
}
