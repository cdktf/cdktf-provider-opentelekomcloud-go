...
func (d *jsiiProxy_DcsInstanceV2BandwidthInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DcsInstanceV2BandwidthInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
