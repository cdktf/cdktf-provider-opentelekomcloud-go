...
func (d *jsiiProxy_DcsInstanceV2BackupPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DcsInstanceV2BackupPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
