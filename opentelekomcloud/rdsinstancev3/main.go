...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "limitSize", GoGetter: "LimitSize"},
			_jsii_.MemberProperty{JsiiProperty: "limitSizeInput", GoGetter: "LimitSizeInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetDiskEncryptionId", GoMethod: "ResetDiskEncryptionId"},
			_jsii_.MemberMethod{JsiiMethod: "resetLimitSize", GoMethod: "ResetLimitSize"},
