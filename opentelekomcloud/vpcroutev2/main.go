...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpcRouteV2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VpcRouteV2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.vpcRouteV2.VpcRouteV2Timeouts",
		reflect.TypeOf((*VpcRouteV2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.vpcRouteV2.VpcRouteV2TimeoutsOutputReference",
		reflect.TypeOf((*VpcRouteV2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
