...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudNatGatewayV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "internalNetworkId", GoGetter: "InternalNetworkId"},
			_jsii_.MemberProperty{JsiiProperty: "internalNetworkIdInput", GoGetter: "InternalNetworkIdInput"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "lifecycle", GoGetter: "Lifecycle"},
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberProperty{JsiiProperty: "natId", GoGetter: "NatId"},
			_jsii_.MemberProperty{JsiiProperty: "natIdInput", GoGetter: "NatIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetInternalNetworkId", GoMethod: "ResetInternalNetworkId"},
			_jsii_.MemberMethod{JsiiMethod: "resetName", GoMethod: "ResetName"},
			_jsii_.MemberMethod{JsiiMethod: "resetNatId", GoMethod: "ResetNatId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataOpentelekomcloudNatGatewayV2Config)(nil)).Elem(),
	)
}
