...
import (
	...
	"github.com/hashicorp/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v3/networkingvipassociatev2/internal"
...
func (j *jsiiProxy_NetworkingVipAssociateV2) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
