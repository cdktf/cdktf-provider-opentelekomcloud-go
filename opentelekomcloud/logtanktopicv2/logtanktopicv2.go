...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LogtankTopicV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "indexEnabled", GoGetter: "IndexEnabled"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LogtankTopicV2Config)(nil)).Elem(),
	)
}
