...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LbL7PolicyV2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LbL7PolicyV2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.lbL7PolicyV2.LbL7PolicyV2Timeouts",
		reflect.TypeOf((*LbL7PolicyV2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.lbL7PolicyV2.LbL7PolicyV2TimeoutsOutputReference",
		reflect.TypeOf((*LbL7PolicyV2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
