...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CssSnapshotConfigurationV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "creationPolicyInput", GoGetter: "CreationPolicyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putCreationPolicy", GoMethod: "PutCreationPolicy"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCreationPolicy", GoMethod: "ResetCreationPolicy"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CssSnapshotConfigurationV1CreationPolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.cssSnapshotConfigurationV1.CssSnapshotConfigurationV1CreationPolicyOutputReference",
		reflect.TypeOf((*CssSnapshotConfigurationV1CreationPolicyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "deleteAuto", GoGetter: "DeleteAuto"},
			_jsii_.MemberProperty{JsiiProperty: "deleteAutoInput", GoGetter: "DeleteAutoInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "keepday", GoGetter: "Keepday"},
			_jsii_.MemberProperty{JsiiProperty: "keepdayInput", GoGetter: "KeepdayInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDeleteAuto", GoMethod: "ResetDeleteAuto"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CssSnapshotConfigurationV1Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.cssSnapshotConfigurationV1.CssSnapshotConfigurationV1TimeoutsOutputReference",
		reflect.TypeOf((*CssSnapshotConfigurationV1TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
