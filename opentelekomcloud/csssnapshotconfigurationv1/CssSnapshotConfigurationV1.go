...
func CssSnapshotConfigurationV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCssSnapshotConfigurationV1_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CssSnapshotConfigurationV1) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CssSnapshotConfigurationV1) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CssSnapshotConfigurationV1) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CssSnapshotConfigurationV1) MoveFromId(id *string) {
...
func (c *jsiiProxy_CssSnapshotConfigurationV1) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CssSnapshotConfigurationV1) MoveToId(id *string) {
...
func (c *jsiiProxy_CssSnapshotConfigurationV1) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CssSnapshotConfigurationV1) ToHclTerraform() interface{} {
	var returns interface{}
