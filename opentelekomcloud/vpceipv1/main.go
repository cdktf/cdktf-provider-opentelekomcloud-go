...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpcEipV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUnbindPort", GoMethod: "ResetUnbindPort"},
			...
			_jsii_.MemberProperty{JsiiProperty: "unbindPort", GoGetter: "UnbindPort"},
			_jsii_.MemberProperty{JsiiProperty: "unbindPortInput", GoGetter: "UnbindPortInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VpcEipV1Bandwidth)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.vpcEipV1.VpcEipV1BandwidthOutputReference",
		reflect.TypeOf((*VpcEipV1BandwidthOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VpcEipV1Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.vpcEipV1.VpcEipV1Publicip",
		reflect.TypeOf((*VpcEipV1Publicip)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.vpcEipV1.VpcEipV1PublicipOutputReference",
		reflect.TypeOf((*VpcEipV1PublicipOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VpcEipV1Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.vpcEipV1.VpcEipV1TimeoutsOutputReference",
		reflect.TypeOf((*VpcEipV1TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
