...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkingSecgroupRuleV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "portRangeMax", GoGetter: "PortRangeMax"},
			_jsii_.MemberProperty{JsiiProperty: "portRangeMaxInput", GoGetter: "PortRangeMaxInput"},
			_jsii_.MemberProperty{JsiiProperty: "portRangeMin", GoGetter: "PortRangeMin"},
			_jsii_.MemberProperty{JsiiProperty: "portRangeMinInput", GoGetter: "PortRangeMinInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPortRangeMax", GoMethod: "ResetPortRangeMax"},
			_jsii_.MemberMethod{JsiiMethod: "resetPortRangeMin", GoMethod: "ResetPortRangeMin"},
