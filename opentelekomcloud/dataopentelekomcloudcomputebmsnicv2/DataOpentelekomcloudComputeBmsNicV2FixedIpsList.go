...
func (d *jsiiProxy_DataOpentelekomcloudComputeBmsNicV2FixedIpsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataOpentelekomcloudComputeBmsNicV2FixedIpsList) Resolve(context cdktf.IResolveContext) interface{} {
