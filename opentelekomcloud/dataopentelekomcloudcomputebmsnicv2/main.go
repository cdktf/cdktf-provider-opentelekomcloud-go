...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudComputeBmsNicV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "fixedIps", GoGetter: "FixedIps"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudComputeBmsNicV2FixedIpsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
