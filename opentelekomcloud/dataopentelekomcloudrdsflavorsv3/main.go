...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudRdsFlavorsV3)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dbTypeInput", GoGetter: "DbTypeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "instanceMode", GoGetter: "InstanceMode"},
			_jsii_.MemberProperty{JsiiProperty: "instanceModeInput", GoGetter: "InstanceModeInput"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudRdsFlavorsV3FlavorsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
