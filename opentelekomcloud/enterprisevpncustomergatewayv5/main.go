...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EnterpriseVpnCustomerGatewayV5)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "idTypeInput", GoGetter: "IdTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "idValue", GoGetter: "IdValue"},
			_jsii_.MemberProperty{JsiiProperty: "idValueInput", GoGetter: "IdValueInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIdType", GoMethod: "ResetIdType"},
			_jsii_.MemberMethod{JsiiMethod: "resetIdValue", GoMethod: "ResetIdValue"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*EnterpriseVpnCustomerGatewayV5Config)(nil)).Elem(),
	)
}
