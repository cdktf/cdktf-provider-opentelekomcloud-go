...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudNetworkingNetworkV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "matchingSubnetCidr", GoGetter: "MatchingSubnetCidr"},
			_jsii_.MemberProperty{JsiiProperty: "matchingSubnetCidrInput", GoGetter: "MatchingSubnetCidrInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMatchingSubnetCidr", GoMethod: "ResetMatchingSubnetCidr"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataOpentelekomcloudNetworkingNetworkV2Config)(nil)).Elem(),
	)
}
