...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LbListenerV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTransparentClientIpEnable", GoMethod: "ResetTransparentClientIpEnable"},
			...
			_jsii_.MemberProperty{JsiiProperty: "transparentClientIpEnableInput", GoGetter: "TransparentClientIpEnableInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LbListenerV2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.lbListenerV2.LbListenerV2IpGroup",
		reflect.TypeOf((*LbListenerV2IpGroup)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LbListenerV2IpGroupOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LbListenerV2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.lbListenerV2.LbListenerV2TimeoutsOutputReference",
		reflect.TypeOf((*LbListenerV2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
