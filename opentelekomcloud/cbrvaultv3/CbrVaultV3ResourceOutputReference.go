...
func (c *jsiiProxy_CbrVaultV3ResourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CbrVaultV3ResourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
