...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VbsBackupShareV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "serviceMetadata", GoGetter: "ServiceMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "shareIds", GoGetter: "ShareIds"},
			...
			_jsii_.MemberProperty{JsiiProperty: "toProjectIds", GoGetter: "ToProjectIds"},
			_jsii_.MemberProperty{JsiiProperty: "toProjectIdsInput", GoGetter: "ToProjectIdsInput"},
