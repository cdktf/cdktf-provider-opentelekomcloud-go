...
// Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.38/docs/resources/as_policy_v2 opentelekomcloud_as_policy_v2} Resource.
...
func (a *jsiiProxy_AsPolicyV2) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AsPolicyV2) MoveFromId(id *string) {
...
func (a *jsiiProxy_AsPolicyV2) MoveToId(id *string) {
...
func (a *jsiiProxy_AsPolicyV2) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AsPolicyV2) ToHclTerraform() interface{} {
	var returns interface{}
