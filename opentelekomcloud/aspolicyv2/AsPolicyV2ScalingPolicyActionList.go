...
func (a *jsiiProxy_AsPolicyV2ScalingPolicyActionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AsPolicyV2ScalingPolicyActionList) Resolve(context cdktf.IResolveContext) interface{} {
