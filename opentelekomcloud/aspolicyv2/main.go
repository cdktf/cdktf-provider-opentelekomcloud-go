...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AsPolicyV2)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "alarmId", GoGetter: "AlarmId"},
			_jsii_.MemberProperty{JsiiProperty: "alarmIdInput", GoGetter: "AlarmIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putScalingPolicyAction", GoMethod: "PutScalingPolicyAction"},
			_jsii_.MemberMethod{JsiiMethod: "putScheduledPolicy", GoMethod: "PutScheduledPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberProperty{JsiiProperty: "region", GoGetter: "Region"},
			_jsii_.MemberProperty{JsiiProperty: "regionInput", GoGetter: "RegionInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetAlarmId", GoMethod: "ResetAlarmId"},
			_jsii_.MemberMethod{JsiiMethod: "resetCoolDownTime", GoMethod: "ResetCoolDownTime"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRegion", GoMethod: "ResetRegion"},
			_jsii_.MemberMethod{JsiiMethod: "resetScalingPolicyAction", GoMethod: "ResetScalingPolicyAction"},
			_jsii_.MemberMethod{JsiiMethod: "resetScheduledPolicy", GoMethod: "ResetScheduledPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "scalingPolicyAction", GoGetter: "ScalingPolicyAction"},
			_jsii_.MemberProperty{JsiiProperty: "scalingPolicyActionInput", GoGetter: "ScalingPolicyActionInput"},
			_jsii_.MemberProperty{JsiiProperty: "scalingPolicyName", GoGetter: "ScalingPolicyName"},
			_jsii_.MemberProperty{JsiiProperty: "scalingPolicyNameInput", GoGetter: "ScalingPolicyNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "scalingPolicyType", GoGetter: "ScalingPolicyType"},
			_jsii_.MemberProperty{JsiiProperty: "scalingPolicyTypeInput", GoGetter: "ScalingPolicyTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "scalingResourceId", GoGetter: "ScalingResourceId"},
			_jsii_.MemberProperty{JsiiProperty: "scalingResourceIdInput", GoGetter: "ScalingResourceIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "scalingResourceType", GoGetter: "ScalingResourceType"},
			_jsii_.MemberProperty{JsiiProperty: "scalingResourceTypeInput", GoGetter: "ScalingResourceTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "scheduledPolicy", GoGetter: "ScheduledPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "scheduledPolicyInput", GoGetter: "ScheduledPolicyInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AsPolicyV2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.asPolicyV2.AsPolicyV2Metadata",
		reflect.TypeOf((*AsPolicyV2Metadata)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.asPolicyV2.AsPolicyV2MetadataList",
		reflect.TypeOf((*AsPolicyV2MetadataList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AsPolicyV2MetadataOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "eipAddress", GoGetter: "EipAddress"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AsPolicyV2ScalingPolicyAction)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.asPolicyV2.AsPolicyV2ScalingPolicyActionList",
		reflect.TypeOf((*AsPolicyV2ScalingPolicyActionList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AsPolicyV2ScalingPolicyActionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AsPolicyV2ScheduledPolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.asPolicyV2.AsPolicyV2ScheduledPolicyList",
		reflect.TypeOf((*AsPolicyV2ScheduledPolicyList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AsPolicyV2ScheduledPolicyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "launchTimeInput", GoGetter: "LaunchTimeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "recurrenceValueInput", GoGetter: "RecurrenceValueInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetEndTime", GoMethod: "ResetEndTime"},
			_jsii_.MemberMethod{JsiiMethod: "resetRecurrenceType", GoMethod: "ResetRecurrenceType"},
			_jsii_.MemberMethod{JsiiMethod: "resetRecurrenceValue", GoMethod: "ResetRecurrenceValue"},
