...
func (c *jsiiProxy_CceNodePoolV3DataVolumesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CceNodePoolV3DataVolumesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
