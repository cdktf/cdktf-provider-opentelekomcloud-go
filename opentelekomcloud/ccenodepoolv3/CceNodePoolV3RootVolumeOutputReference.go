...
func (c *jsiiProxy_CceNodePoolV3RootVolumeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CceNodePoolV3RootVolumeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
