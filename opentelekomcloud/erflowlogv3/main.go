...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ErFlowLogV3)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "logStoreType", GoGetter: "LogStoreType"},
			_jsii_.MemberProperty{JsiiProperty: "logStoreTypeInput", GoGetter: "LogStoreTypeInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.erFlowLogV3.ErFlowLogV3Config",
		reflect.TypeOf((*ErFlowLogV3Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.erFlowLogV3.ErFlowLogV3Timeouts",
		reflect.TypeOf((*ErFlowLogV3Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.erFlowLogV3.ErFlowLogV3TimeoutsOutputReference",
		reflect.TypeOf((*ErFlowLogV3TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
