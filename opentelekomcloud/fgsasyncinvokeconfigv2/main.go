...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FgsAsyncInvokeConfigV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "maxAsyncEventAgeInSeconds", GoGetter: "MaxAsyncEventAgeInSeconds"},
			_jsii_.MemberProperty{JsiiProperty: "maxAsyncEventAgeInSecondsInput", GoGetter: "MaxAsyncEventAgeInSecondsInput"},
			_jsii_.MemberProperty{JsiiProperty: "maxAsyncRetryAttempts", GoGetter: "MaxAsyncRetryAttempts"},
			_jsii_.MemberProperty{JsiiProperty: "maxAsyncRetryAttemptsInput", GoGetter: "MaxAsyncRetryAttemptsInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*FgsAsyncInvokeConfigV2OnSuccess)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.fgsAsyncInvokeConfigV2.FgsAsyncInvokeConfigV2OnSuccessOutputReference",
		reflect.TypeOf((*FgsAsyncInvokeConfigV2OnSuccessOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
