...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LtsCrossAccountAccessV2)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "accessConfigType", GoGetter: "AccessConfigType"},
			...
			_jsii_.MemberProperty{JsiiProperty: "logAgencyGroupId", GoGetter: "LogAgencyGroupId"},
			_jsii_.MemberProperty{JsiiProperty: "logAgencyGroupIdInput", GoGetter: "LogAgencyGroupIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "logAgencyGroupName", GoGetter: "LogAgencyGroupName"},
			_jsii_.MemberProperty{JsiiProperty: "logAgencyGroupNameInput", GoGetter: "LogAgencyGroupNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "logAgencyStreamId", GoGetter: "LogAgencyStreamId"},
			_jsii_.MemberProperty{JsiiProperty: "logAgencyStreamIdInput", GoGetter: "LogAgencyStreamIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "logAgencyStreamName", GoGetter: "LogAgencyStreamName"},
			_jsii_.MemberProperty{JsiiProperty: "logAgencyStreamNameInput", GoGetter: "LogAgencyStreamNameInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.ltsCrossAccountAccessV2.LtsCrossAccountAccessV2Config",
		reflect.TypeOf((*LtsCrossAccountAccessV2Config)(nil)).Elem(),
	)
}
