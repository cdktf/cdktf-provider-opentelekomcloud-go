...
func (d *jsiiProxy_DataOpentelekomcloudDdsFlavorsV3FlavorsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataOpentelekomcloudDdsFlavorsV3FlavorsList) Resolve(context cdktf.IResolveContext) interface{} {
