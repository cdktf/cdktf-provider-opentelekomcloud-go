...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigwApiPublishmentV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "publishId", GoGetter: "PublishId"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApigwApiPublishmentV2HistoryOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
