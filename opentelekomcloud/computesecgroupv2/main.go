...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ComputeSecgroupV2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ComputeSecgroupV2RuleOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberProperty{JsiiProperty: "fromGroupId", GoGetter: "FromGroupId"},
			_jsii_.MemberProperty{JsiiProperty: "fromGroupIdInput", GoGetter: "FromGroupIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFromGroupId", GoMethod: "ResetFromGroupId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ComputeSecgroupV2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.computeSecgroupV2.ComputeSecgroupV2TimeoutsOutputReference",
		reflect.TypeOf((*ComputeSecgroupV2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
