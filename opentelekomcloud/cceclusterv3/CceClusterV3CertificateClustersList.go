...
type CceClusterV3CertificateClustersList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) CceClusterV3CertificateClustersOutputReference
...
// The jsii proxy struct for CceClusterV3CertificateClustersList
type jsiiProxy_CceClusterV3CertificateClustersList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_CceClusterV3CertificateClustersList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CceClusterV3CertificateClustersList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CceClusterV3CertificateClustersList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_CceClusterV3CertificateClustersList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_CceClusterV3CertificateClustersList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (c *jsiiProxy_CceClusterV3CertificateClustersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CceClusterV3CertificateClustersList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CceClusterV3CertificateClustersList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CceClusterV3CertificateClustersList) ToString() *string {
	var returns *string
