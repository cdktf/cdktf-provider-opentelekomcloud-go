...
type CceClusterV3Config struct {
	...
	ApiAccessTrustlist *[]*string `field:"optional" json:"apiAccessTrustlist" yaml:"apiAccessTrustlist"`
	...
	ComponentConfigurations interface{} `field:"optional" json:"componentConfigurations" yaml:"componentConfigurations"`
	...
	CustomSan *[]*string `field:"optional" json:"customSan" yaml:"customSan"`
	...
	Masters interface{} `field:"optional" json:"masters" yaml:"masters"`
	...
	SupportIstio interface{} `field:"optional" json:"supportIstio" yaml:"supportIstio"`
	// timeouts block.
	//
