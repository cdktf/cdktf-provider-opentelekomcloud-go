...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpnaasIpsecPolicyV2)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "authAlgorithm", GoGetter: "AuthAlgorithm"},
			_jsii_.MemberProperty{JsiiProperty: "authAlgorithmInput", GoGetter: "AuthAlgorithmInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAuthAlgorithm", GoMethod: "ResetAuthAlgorithm"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpnaasIpsecPolicyV2LifetimeOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VpnaasIpsecPolicyV2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.vpnaasIpsecPolicyV2.VpnaasIpsecPolicyV2TimeoutsOutputReference",
		reflect.TypeOf((*VpnaasIpsecPolicyV2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
