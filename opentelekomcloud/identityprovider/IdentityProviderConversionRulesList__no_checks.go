...
func (i *jsiiProxy_IdentityProviderConversionRulesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (i *jsiiProxy_IdentityProviderConversionRulesList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
