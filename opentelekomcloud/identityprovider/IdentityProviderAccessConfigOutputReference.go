...
func (i *jsiiProxy_IdentityProviderAccessConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IdentityProviderAccessConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
