...
func (i *jsiiProxy_IdentityProviderConversionRulesLocalOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IdentityProviderConversionRulesLocalOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
