...
func (i *jsiiProxy_IdentityProviderConversionRulesLocalList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IdentityProviderConversionRulesLocalList) Resolve(context cdktf.IResolveContext) interface{} {
