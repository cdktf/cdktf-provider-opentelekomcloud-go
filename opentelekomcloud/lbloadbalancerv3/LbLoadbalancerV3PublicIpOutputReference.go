...
func (l *jsiiProxy_LbLoadbalancerV3PublicIpOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbLoadbalancerV3PublicIpOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
