...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpnaasIkePolicyV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "phase1NegotiationMode", GoGetter: "Phase1NegotiationMode"},
			_jsii_.MemberProperty{JsiiProperty: "phase1NegotiationModeInput", GoGetter: "Phase1NegotiationModeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPhase1NegotiationMode", GoMethod: "ResetPhase1NegotiationMode"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpnaasIkePolicyV2LifetimeOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VpnaasIkePolicyV2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.vpnaasIkePolicyV2.VpnaasIkePolicyV2TimeoutsOutputReference",
		reflect.TypeOf((*VpnaasIkePolicyV2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
