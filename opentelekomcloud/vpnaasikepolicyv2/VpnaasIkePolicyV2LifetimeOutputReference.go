...
func (v *jsiiProxy_VpnaasIkePolicyV2LifetimeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnaasIkePolicyV2LifetimeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
