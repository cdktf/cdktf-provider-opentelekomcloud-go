...
func (j *jsiiProxy_DataOpentelekomcloudVpcV1) Count() interface{} {
...
func NewDataOpentelekomcloudVpcV1(scope constructs.Construct, id *string, config *DataOpentelekomcloudVpcV1Config) DataOpentelekomcloudVpcV1 {
	...
	if err := validateNewDataOpentelekomcloudVpcV1Parameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataOpentelekomcloudVpcV1)SetCount(val interface{}) {
...
func DataOpentelekomcloudVpcV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataOpentelekomcloudVpcV1_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataOpentelekomcloudVpcV1_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataOpentelekomcloudVpcV1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataOpentelekomcloudVpcV1_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataOpentelekomcloudVpcV1_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataOpentelekomcloudVpcV1_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataOpentelekomcloudVpcV1_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataOpentelekomcloudVpcV1) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataOpentelekomcloudVpcV1) ToHclTerraform() interface{} {
	var returns interface{}
