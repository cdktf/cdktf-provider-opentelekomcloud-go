...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ObsBucketReplication)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "destinationBucket", GoGetter: "DestinationBucket"},
			_jsii_.MemberProperty{JsiiProperty: "destinationBucketInput", GoGetter: "DestinationBucketInput"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ObsBucketReplicationRuleOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "deleteData", GoGetter: "DeleteData"},
			_jsii_.MemberProperty{JsiiProperty: "deleteDataInput", GoGetter: "DeleteDataInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "historyEnabled", GoGetter: "HistoryEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "historyEnabledInput", GoGetter: "HistoryEnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "id", GoGetter: "Id"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDeleteData", GoMethod: "ResetDeleteData"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnabled", GoMethod: "ResetEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetHistoryEnabled", GoMethod: "ResetHistoryEnabled"},
