...
func (j *jsiiProxy_VpcPeeringConnectionAccepterV2) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_VpcPeeringConnectionAccepterV2)SetCount(val interface{}) {
...
func VpcPeeringConnectionAccepterV2_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateVpcPeeringConnectionAccepterV2_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func VpcPeeringConnectionAccepterV2_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVpcPeeringConnectionAccepterV2_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VpcPeeringConnectionAccepterV2_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVpcPeeringConnectionAccepterV2_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterV2) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterV2) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterV2) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterV2) MoveFromId(id *string) {
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterV2) MoveTo(moveTarget *string, index interface{}) {
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterV2) MoveToId(id *string) {
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterV2) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterV2) ToHclTerraform() interface{} {
	var returns interface{}
