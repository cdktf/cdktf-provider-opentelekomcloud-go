...
func (d *jsiiProxy_DcsInstanceV1WhitelistStructList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DcsInstanceV1WhitelistStructList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
