...
func (c *jsiiProxy_CtsEventNotificationV3) validateMoveFromIdParameters(id *string) error {
	return nil
}
...
func (c *jsiiProxy_CtsEventNotificationV3) validateMoveToIdParameters(id *string) error {
	return nil
}
