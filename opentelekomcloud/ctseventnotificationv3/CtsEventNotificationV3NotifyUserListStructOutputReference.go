...
type CtsEventNotificationV3NotifyUserListStructOutputReference interface {
	...
	UserList() *[]*string
	SetUserList(val *[]*string)
	UserListInput() *[]*string
	// Experimental.
	ComputeFqn() *string
	// Experimental.
...
func (c *jsiiProxy_CtsEventNotificationV3NotifyUserListStructOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CtsEventNotificationV3NotifyUserListStructOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
