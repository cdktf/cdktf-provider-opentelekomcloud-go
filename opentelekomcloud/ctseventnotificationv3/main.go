...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CtsEventNotificationV3)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "notificationName", GoGetter: "NotificationName"},
			_jsii_.MemberProperty{JsiiProperty: "notificationNameInput", GoGetter: "NotificationNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "notificationType", GoGetter: "NotificationType"},
			_jsii_.MemberProperty{JsiiProperty: "notifyUserList", GoGetter: "NotifyUserList"},
			_jsii_.MemberProperty{JsiiProperty: "notifyUserListInput", GoGetter: "NotifyUserListInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putNotifyUserList", GoMethod: "PutNotifyUserList"},
			_jsii_.MemberMethod{JsiiMethod: "putOperations", GoMethod: "PutOperations"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetFilter", GoMethod: "ResetFilter"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetNotifyUserList", GoMethod: "ResetNotifyUserList"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.ctsEventNotificationV3.CtsEventNotificationV3Filter",
		reflect.TypeOf((*CtsEventNotificationV3Filter)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.ctsEventNotificationV3.CtsEventNotificationV3FilterOutputReference",
		reflect.TypeOf((*CtsEventNotificationV3FilterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "userList", GoGetter: "UserList"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CtsEventNotificationV3Operations)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.ctsEventNotificationV3.CtsEventNotificationV3OperationsList",
		reflect.TypeOf((*CtsEventNotificationV3OperationsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CtsEventNotificationV3OperationsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "traceNames", GoGetter: "TraceNames"},
			_jsii_.MemberProperty{JsiiProperty: "traceNamesInput", GoGetter: "TraceNamesInput"},
		},
		func() interface{} {
