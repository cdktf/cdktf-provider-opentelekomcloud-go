...
func (d *jsiiProxy_DdsInstanceV3NodesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DdsInstanceV3NodesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
