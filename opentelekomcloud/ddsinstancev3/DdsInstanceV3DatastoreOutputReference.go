...
func NewDdsInstanceV3DatastoreOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DdsInstanceV3DatastoreOutputReference {
	...
	if err := validateNewDdsInstanceV3DatastoreOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DdsInstanceV3DatastoreOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DdsInstanceV3DatastoreOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
