...
func NewDataOpentelekomcloudObsBucketLifecycleRuleTransitionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataOpentelekomcloudObsBucketLifecycleRuleTransitionOutputReference {
	...
	if err := validateNewDataOpentelekomcloudObsBucketLifecycleRuleTransitionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataOpentelekomcloudObsBucketLifecycleRuleTransitionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataOpentelekomcloudObsBucketLifecycleRuleTransitionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
