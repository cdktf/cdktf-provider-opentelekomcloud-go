...
func (d *jsiiProxy_DataOpentelekomcloudObsBucketEventNotificationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataOpentelekomcloudObsBucketEventNotificationsList) Resolve(context cdktf.IResolveContext) interface{} {
