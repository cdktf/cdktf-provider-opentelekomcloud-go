...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BlockstorageVolumeV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "consistencyGroupId", GoGetter: "ConsistencyGroupId"},
			_jsii_.MemberProperty{JsiiProperty: "consistencyGroupIdInput", GoGetter: "ConsistencyGroupIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetConsistencyGroupId", GoMethod: "ResetConsistencyGroupId"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSourceReplica", GoMethod: "ResetSourceReplica"},
			_jsii_.MemberMethod{JsiiMethod: "resetSourceVolId", GoMethod: "ResetSourceVolId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceReplica", GoGetter: "SourceReplica"},
			_jsii_.MemberProperty{JsiiProperty: "sourceReplicaInput", GoGetter: "SourceReplicaInput"},
			_jsii_.MemberProperty{JsiiProperty: "sourceVolId", GoGetter: "SourceVolId"},
			_jsii_.MemberProperty{JsiiProperty: "sourceVolIdInput", GoGetter: "SourceVolIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "wwn", GoGetter: "Wwn"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*BlockstorageVolumeV2Attachment)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.blockstorageVolumeV2.BlockstorageVolumeV2AttachmentList",
		reflect.TypeOf((*BlockstorageVolumeV2AttachmentList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BlockstorageVolumeV2AttachmentOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
