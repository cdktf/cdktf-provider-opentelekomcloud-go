...
func (a *jsiiProxy_ApigwApiV2HttpOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApigwApiV2HttpOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
