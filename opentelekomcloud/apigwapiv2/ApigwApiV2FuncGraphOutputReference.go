...
func (a *jsiiProxy_ApigwApiV2FuncGraphOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApigwApiV2FuncGraphOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
