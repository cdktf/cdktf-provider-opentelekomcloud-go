...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RtsStackV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "notificationTopics", GoGetter: "NotificationTopics"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTimeoutMins", GoMethod: "ResetTimeoutMins"},
			...
			_jsii_.MemberProperty{JsiiProperty: "timeoutMinsInput", GoGetter: "TimeoutMinsInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*RtsStackV1Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.rtsStackV1.RtsStackV1Timeouts",
		reflect.TypeOf((*RtsStackV1Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.rtsStackV1.RtsStackV1TimeoutsOutputReference",
		reflect.TypeOf((*RtsStackV1TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
