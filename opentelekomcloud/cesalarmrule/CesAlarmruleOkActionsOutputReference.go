...
func NewCesAlarmruleOkActionsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CesAlarmruleOkActionsOutputReference {
	...
	if err := validateNewCesAlarmruleOkActionsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CesAlarmruleOkActionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CesAlarmruleOkActionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
