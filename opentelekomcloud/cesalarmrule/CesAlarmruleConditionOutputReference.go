...
func (c *jsiiProxy_CesAlarmruleConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CesAlarmruleConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
