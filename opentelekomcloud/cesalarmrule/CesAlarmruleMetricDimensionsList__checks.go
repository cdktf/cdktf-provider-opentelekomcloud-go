...
func (c *jsiiProxy_CesAlarmruleMetricDimensionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (c *jsiiProxy_CesAlarmruleMetricDimensionsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
