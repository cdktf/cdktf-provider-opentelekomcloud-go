...
type IdentityAgencyV3ProjectRoleList interface {
	cdktf.ComplexList
...
// The jsii proxy struct for IdentityAgencyV3ProjectRoleList
type jsiiProxy_IdentityAgencyV3ProjectRoleList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_IdentityAgencyV3ProjectRoleList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_IdentityAgencyV3ProjectRoleList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IdentityAgencyV3ProjectRoleList) InternalValue() interface{} {
...
func (j *jsiiProxy_IdentityAgencyV3ProjectRoleList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_IdentityAgencyV3ProjectRoleList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_IdentityAgencyV3ProjectRoleList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewIdentityAgencyV3ProjectRoleList_Override(i IdentityAgencyV3ProjectRoleList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (i *jsiiProxy_IdentityAgencyV3ProjectRoleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IdentityAgencyV3ProjectRoleList) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IdentityAgencyV3ProjectRoleList) ToString() *string {
	var returns *string
