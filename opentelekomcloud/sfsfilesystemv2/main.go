...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SfsFileSystemV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "accessRuleStatus", GoGetter: "AccessRuleStatus"},
			_jsii_.MemberProperty{JsiiProperty: "accessTo", GoGetter: "AccessTo"},
			_jsii_.MemberProperty{JsiiProperty: "accessToInput", GoGetter: "AccessToInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAccessTo", GoMethod: "ResetAccessTo"},
			...
			_jsii_.MemberProperty{JsiiProperty: "shareAccessId", GoGetter: "ShareAccessId"},
