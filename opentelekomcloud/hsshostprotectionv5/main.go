...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*HssHostProtectionV5)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isWaitHostAvailable", GoGetter: "IsWaitHostAvailable"},
			_jsii_.MemberProperty{JsiiProperty: "isWaitHostAvailableInput", GoGetter: "IsWaitHostAvailableInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsWaitHostAvailable", GoMethod: "ResetIsWaitHostAvailable"},
