...
import (
	...
	"github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v4/dataopentelekomcloudvpcpeeringconnectionv2/internal"
...
func (j *jsiiProxy_DataOpentelekomcloudVpcPeeringConnectionV2) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
