...
func (l *jsiiProxy_LbListenerV3InsertHeadersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbListenerV3InsertHeadersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
