...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SwrDomainV2)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "accessDomain", GoGetter: "AccessDomain"},
			_jsii_.MemberProperty{JsiiProperty: "accessDomainInput", GoGetter: "AccessDomainInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "deadline", GoGetter: "Deadline"},
			_jsii_.MemberProperty{JsiiProperty: "deadlineInput", GoGetter: "DeadlineInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SwrDomainV2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.swrDomainV2.SwrDomainV2Timeouts",
		reflect.TypeOf((*SwrDomainV2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.swrDomainV2.SwrDomainV2TimeoutsOutputReference",
		reflect.TypeOf((*SwrDomainV2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
