...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SmnSubscriptionV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "remarkInput", GoGetter: "RemarkInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetProjectName", GoMethod: "ResetProjectName"},
			_jsii_.MemberMethod{JsiiMethod: "resetRemark", GoMethod: "ResetRemark"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SmnSubscriptionV2Config)(nil)).Elem(),
	)
}
