...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpcFlowLogV1)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "adminState", GoGetter: "AdminState"},
			_jsii_.MemberProperty{JsiiProperty: "adminStateInput", GoGetter: "AdminStateInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAdminState", GoMethod: "ResetAdminState"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VpcFlowLogV1Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.vpcFlowLogV1.VpcFlowLogV1Timeouts",
		reflect.TypeOf((*VpcFlowLogV1Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.vpcFlowLogV1.VpcFlowLogV1TimeoutsOutputReference",
		reflect.TypeOf((*VpcFlowLogV1TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
