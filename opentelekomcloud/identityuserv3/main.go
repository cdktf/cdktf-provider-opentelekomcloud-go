...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "defaultProjectIdInput", GoGetter: "DefaultProjectIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultProjectId", GoMethod: "ResetDefaultProjectId"},
