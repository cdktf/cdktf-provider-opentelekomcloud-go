...
func (j *jsiiProxy_CceNodeV3) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.18/docs/resources/cce_node_v3 opentelekomcloud_cce_node_v3} Resource.
...
func (j *jsiiProxy_CceNodeV3)SetCount(val interface{}) {
...
func CceNodeV3_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCceNodeV3_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CceNodeV3) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CceNodeV3) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CceNodeV3) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CceNodeV3) MoveFromId(id *string) {
...
func (c *jsiiProxy_CceNodeV3) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CceNodeV3) MoveToId(id *string) {
...
func (c *jsiiProxy_CceNodeV3) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CceNodeV3) ToHclTerraform() interface{} {
	var returns interface{}
