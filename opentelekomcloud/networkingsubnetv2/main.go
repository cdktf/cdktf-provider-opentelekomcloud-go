...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkingSubnetV2)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "allocationPools", GoGetter: "AllocationPools"},
			_jsii_.MemberProperty{JsiiProperty: "allocationPoolsInput", GoGetter: "AllocationPoolsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "enableDhcp", GoGetter: "EnableDhcp"},
			_jsii_.MemberProperty{JsiiProperty: "enableDhcpInput", GoGetter: "EnableDhcpInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "hostRoutes", GoGetter: "HostRoutes"},
			_jsii_.MemberProperty{JsiiProperty: "hostRoutesInput", GoGetter: "HostRoutesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "noGateway", GoGetter: "NoGateway"},
			_jsii_.MemberProperty{JsiiProperty: "noGatewayInput", GoGetter: "NoGatewayInput"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putAllocationPools", GoMethod: "PutAllocationPools"},
			_jsii_.MemberMethod{JsiiMethod: "putHostRoutes", GoMethod: "PutHostRoutes"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberProperty{JsiiProperty: "region", GoGetter: "Region"},
			_jsii_.MemberProperty{JsiiProperty: "regionInput", GoGetter: "RegionInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllocationPools", GoMethod: "ResetAllocationPools"},
			_jsii_.MemberMethod{JsiiMethod: "resetDnsNameservers", GoMethod: "ResetDnsNameservers"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnableDhcp", GoMethod: "ResetEnableDhcp"},
			_jsii_.MemberMethod{JsiiMethod: "resetGatewayIp", GoMethod: "ResetGatewayIp"},
			_jsii_.MemberMethod{JsiiMethod: "resetHostRoutes", GoMethod: "ResetHostRoutes"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetIpVersion", GoMethod: "ResetIpVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resetName", GoMethod: "ResetName"},
			_jsii_.MemberMethod{JsiiMethod: "resetNoGateway", GoMethod: "ResetNoGateway"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkingSubnetV2AllocationPools)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.networkingSubnetV2.NetworkingSubnetV2AllocationPoolsList",
		reflect.TypeOf((*NetworkingSubnetV2AllocationPoolsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_NetworkingSubnetV2AllocationPoolsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkingSubnetV2AllocationPoolsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkingSubnetV2HostRoutesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkingSubnetV2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.networkingSubnetV2.NetworkingSubnetV2TimeoutsOutputReference",
		reflect.TypeOf((*NetworkingSubnetV2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
