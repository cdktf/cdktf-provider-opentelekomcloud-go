...
type NetworkingSubnetV2HostRoutesList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) NetworkingSubnetV2HostRoutesOutputReference
...
// The jsii proxy struct for NetworkingSubnetV2HostRoutesList
type jsiiProxy_NetworkingSubnetV2HostRoutesList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_NetworkingSubnetV2HostRoutesList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_NetworkingSubnetV2HostRoutesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NetworkingSubnetV2HostRoutesList) InternalValue() interface{} {
...
func (j *jsiiProxy_NetworkingSubnetV2HostRoutesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_NetworkingSubnetV2HostRoutesList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_NetworkingSubnetV2HostRoutesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (n *jsiiProxy_NetworkingSubnetV2HostRoutesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkingSubnetV2HostRoutesList) ComputeFqn() *string {
	var returns *string
...
func (n *jsiiProxy_NetworkingSubnetV2HostRoutesList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (n *jsiiProxy_NetworkingSubnetV2HostRoutesList) ToString() *string {
	var returns *string
