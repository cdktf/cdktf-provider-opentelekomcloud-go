...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PrivateNatTransitIpV3)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.privateNatTransitIpV3.PrivateNatTransitIpV3Config",
		reflect.TypeOf((*PrivateNatTransitIpV3Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.privateNatTransitIpV3.PrivateNatTransitIpV3Timeouts",
		reflect.TypeOf((*PrivateNatTransitIpV3Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.privateNatTransitIpV3.PrivateNatTransitIpV3TimeoutsOutputReference",
		reflect.TypeOf((*PrivateNatTransitIpV3TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
