...
func (d *jsiiProxy_DisStreamV2PartitionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DisStreamV2PartitionsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
