...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DcVirtualGatewayV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putLocalEpGroup", GoMethod: "PutLocalEpGroup"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberProperty{JsiiProperty: "redundantDeviceId", GoGetter: "RedundantDeviceId"},
			_jsii_.MemberProperty{JsiiProperty: "redundantDeviceIdInput", GoGetter: "RedundantDeviceIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRedundantDeviceId", GoMethod: "ResetRedundantDeviceId"},
