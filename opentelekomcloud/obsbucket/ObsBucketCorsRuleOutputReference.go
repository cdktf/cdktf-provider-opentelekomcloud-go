...
func (o *jsiiProxy_ObsBucketCorsRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_ObsBucketCorsRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
