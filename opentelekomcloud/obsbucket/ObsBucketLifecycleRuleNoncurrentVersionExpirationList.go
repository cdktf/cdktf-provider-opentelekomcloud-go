...
func (o *jsiiProxy_ObsBucketLifecycleRuleNoncurrentVersionExpirationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_ObsBucketLifecycleRuleNoncurrentVersionExpirationList) Resolve(context cdktf.IResolveContext) interface{} {
