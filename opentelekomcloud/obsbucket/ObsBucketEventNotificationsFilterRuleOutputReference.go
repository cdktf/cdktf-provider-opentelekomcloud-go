...
type ObsBucketEventNotificationsFilterRuleOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for ObsBucketEventNotificationsFilterRuleOutputReference
type jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) Value() *string {
	var returns *string
	_jsii_.Get(
		j,
		"value",
...
func (j *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) ValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"valueInput",
...
func (o *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (o *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) ResetName() {
	_jsii_.InvokeVoid(
		o,
		"resetName",
		nil, // no parameters
...
func (o *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) ResetValue() {
	_jsii_.InvokeVoid(
		o,
		"resetValue",
		nil, // no parameters
...
func (o *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_ObsBucketEventNotificationsFilterRuleOutputReference) ToString() *string {
	var returns *string
