...
type ObsBucketCorsRuleList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) ObsBucketCorsRuleOutputReference
...
// The jsii proxy struct for ObsBucketCorsRuleList
type jsiiProxy_ObsBucketCorsRuleList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ObsBucketCorsRuleList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ObsBucketCorsRuleList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ObsBucketCorsRuleList) InternalValue() interface{} {
...
func (j *jsiiProxy_ObsBucketCorsRuleList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ObsBucketCorsRuleList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ObsBucketCorsRuleList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (o *jsiiProxy_ObsBucketCorsRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_ObsBucketCorsRuleList) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_ObsBucketCorsRuleList) ToString() *string {
	var returns *string
