...
func (o *jsiiProxy_ObsBucketWebsiteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_ObsBucketWebsiteOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
