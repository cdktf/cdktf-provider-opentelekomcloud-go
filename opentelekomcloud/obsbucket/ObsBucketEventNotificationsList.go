...
type ObsBucketEventNotificationsList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) ObsBucketEventNotificationsOutputReference
...
// The jsii proxy struct for ObsBucketEventNotificationsList
type jsiiProxy_ObsBucketEventNotificationsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ObsBucketEventNotificationsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ObsBucketEventNotificationsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ObsBucketEventNotificationsList) InternalValue() interface{} {
...
func (j *jsiiProxy_ObsBucketEventNotificationsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ObsBucketEventNotificationsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ObsBucketEventNotificationsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (o *jsiiProxy_ObsBucketEventNotificationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_ObsBucketEventNotificationsList) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_ObsBucketEventNotificationsList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_ObsBucketEventNotificationsList) ToString() *string {
	var returns *string
