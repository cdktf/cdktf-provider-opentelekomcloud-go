...
func (j *jsiiProxy_ObsBucket) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.18/docs/resources/obs_bucket opentelekomcloud_obs_bucket} Resource.
...
func (j *jsiiProxy_ObsBucket)SetCount(val interface{}) {
...
func ObsBucket_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateObsBucket_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ObsBucket_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateObsBucket_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func ObsBucket_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateObsBucket_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (o *jsiiProxy_ObsBucket) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_ObsBucket) HasResourceMove() interface{} {
	var returns interface{}
...
func (o *jsiiProxy_ObsBucket) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (o *jsiiProxy_ObsBucket) MoveFromId(id *string) {
...
func (o *jsiiProxy_ObsBucket) MoveTo(moveTarget *string, index interface{}) {
...
func (o *jsiiProxy_ObsBucket) MoveToId(id *string) {
...
func (o *jsiiProxy_ObsBucket) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (o *jsiiProxy_ObsBucket) ToHclTerraform() interface{} {
	var returns interface{}
