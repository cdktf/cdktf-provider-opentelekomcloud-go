...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LbLoadbalancerV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "loadbalancerProvider", GoGetter: "LoadbalancerProvider"},
			_jsii_.MemberProperty{JsiiProperty: "loadbalancerProviderInput", GoGetter: "LoadbalancerProviderInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLoadbalancerProvider", GoMethod: "ResetLoadbalancerProvider"},
			...
			_jsii_.MemberProperty{JsiiProperty: "vipSubnetId", GoGetter: "VipSubnetId"},
			_jsii_.MemberProperty{JsiiProperty: "vipSubnetIdInput", GoGetter: "VipSubnetIdInput"},
		},
		func() interface{} {
