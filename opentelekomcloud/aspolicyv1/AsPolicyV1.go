...
import (
	...
	"github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v12/aspolicyv1/internal"
...
func (j *jsiiProxy_AsPolicyV1) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func NewAsPolicyV1(scope constructs.Construct, id *string, config *AsPolicyV1Config) AsPolicyV1 {
	...
	if err := validateNewAsPolicyV1Parameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AsPolicyV1)SetCount(val interface{}) {
...
func AsPolicyV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAsPolicyV1_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AsPolicyV1_IsConstruct(x interface{}) *bool {
	...
	if err := validateAsPolicyV1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AsPolicyV1_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAsPolicyV1_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AsPolicyV1_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAsPolicyV1_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AsPolicyV1) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AsPolicyV1) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AsPolicyV1) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AsPolicyV1) MoveFromId(id *string) {
...
func (a *jsiiProxy_AsPolicyV1) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_AsPolicyV1) MoveToId(id *string) {
...
func (a *jsiiProxy_AsPolicyV1) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AsPolicyV1) ToHclTerraform() interface{} {
	var returns interface{}
