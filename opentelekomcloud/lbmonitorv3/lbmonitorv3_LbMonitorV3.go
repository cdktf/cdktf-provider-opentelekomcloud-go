...
import (
	...
	"github.com/hashicorp/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v3/lbmonitorv3/internal"
...
func (j *jsiiProxy_LbMonitorV3) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LbMonitorV3)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
