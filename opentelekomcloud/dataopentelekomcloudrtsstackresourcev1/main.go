...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudRtsStackResourceV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "logicalResourceId", GoGetter: "LogicalResourceId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "requiredBy", GoGetter: "RequiredBy"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPhysicalResourceId", GoMethod: "ResetPhysicalResourceId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "resourceStatusReason", GoGetter: "ResourceStatusReason"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataOpentelekomcloudRtsStackResourceV1Config)(nil)).Elem(),
	)
}
