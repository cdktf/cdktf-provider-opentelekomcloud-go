...
func (d *jsiiProxy_DataOpentelekomcloudLbListenerV3InsertHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataOpentelekomcloudLbListenerV3InsertHeadersList) Resolve(context cdktf.IResolveContext) interface{} {
