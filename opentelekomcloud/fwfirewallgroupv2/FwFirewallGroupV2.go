...
func FwFirewallGroupV2_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateFwFirewallGroupV2_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FwFirewallGroupV2) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FwFirewallGroupV2) HasResourceMove() interface{} {
	var returns interface{}
...
func (f *jsiiProxy_FwFirewallGroupV2) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (f *jsiiProxy_FwFirewallGroupV2) MoveFromId(id *string) {
...
func (f *jsiiProxy_FwFirewallGroupV2) MoveTo(moveTarget *string, index interface{}) {
...
func (f *jsiiProxy_FwFirewallGroupV2) MoveToId(id *string) {
...
func (f *jsiiProxy_FwFirewallGroupV2) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (f *jsiiProxy_FwFirewallGroupV2) ToHclTerraform() interface{} {
	var returns interface{}
