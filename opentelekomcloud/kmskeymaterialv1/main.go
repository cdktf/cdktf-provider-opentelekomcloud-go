...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KmsKeyMaterialV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "encryptedKeyMaterial", GoGetter: "EncryptedKeyMaterial"},
			_jsii_.MemberProperty{JsiiProperty: "encryptedKeyMaterialInput", GoGetter: "EncryptedKeyMaterialInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "importTokenInput", GoGetter: "ImportTokenInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*KmsKeyMaterialV1Config)(nil)).Elem(),
	)
}
