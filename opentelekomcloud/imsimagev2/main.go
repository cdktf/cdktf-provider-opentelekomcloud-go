...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ImsImageV2)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "cmkId", GoGetter: "CmkId"},
			_jsii_.MemberProperty{JsiiProperty: "cmkIdInput", GoGetter: "CmkIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "imageSize", GoGetter: "ImageSize"},
			...
			_jsii_.MemberProperty{JsiiProperty: "isConfig", GoGetter: "IsConfig"},
			_jsii_.MemberProperty{JsiiProperty: "isConfigInput", GoGetter: "IsConfigInput"},
			_jsii_.MemberProperty{JsiiProperty: "lifecycle", GoGetter: "Lifecycle"},
			_jsii_.MemberProperty{JsiiProperty: "maxRam", GoGetter: "MaxRam"},
			_jsii_.MemberProperty{JsiiProperty: "maxRamInput", GoGetter: "MaxRamInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCmkId", GoMethod: "ResetCmkId"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsConfig", GoMethod: "ResetIsConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaxRam", GoMethod: "ResetMaxRam"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ImsImageV2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.imsImageV2.ImsImageV2Timeouts",
		reflect.TypeOf((*ImsImageV2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.imsImageV2.ImsImageV2TimeoutsOutputReference",
		reflect.TypeOf((*ImsImageV2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
