...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FwRuleV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSourceIpAddress", GoMethod: "ResetSourceIpAddress"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceIpAddress", GoGetter: "SourceIpAddress"},
			_jsii_.MemberProperty{JsiiProperty: "sourceIpAddressInput", GoGetter: "SourceIpAddressInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*FwRuleV2Config)(nil)).Elem(),
	)
}
