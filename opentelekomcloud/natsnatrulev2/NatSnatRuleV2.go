...
func (j *jsiiProxy_NatSnatRuleV2) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_NatSnatRuleV2)SetCount(val interface{}) {
...
func NatSnatRuleV2_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateNatSnatRuleV2_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func NatSnatRuleV2_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateNatSnatRuleV2_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func NatSnatRuleV2_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateNatSnatRuleV2_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (n *jsiiProxy_NatSnatRuleV2) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NatSnatRuleV2) HasResourceMove() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NatSnatRuleV2) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_NatSnatRuleV2) MoveFromId(id *string) {
...
func (n *jsiiProxy_NatSnatRuleV2) MoveTo(moveTarget *string, index interface{}) {
...
func (n *jsiiProxy_NatSnatRuleV2) MoveToId(id *string) {
...
func (n *jsiiProxy_NatSnatRuleV2) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NatSnatRuleV2) ToHclTerraform() interface{} {
	var returns interface{}
