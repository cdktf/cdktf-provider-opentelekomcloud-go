...
func (c *jsiiProxy_ComputeBmsServerV2NetworkOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeBmsServerV2NetworkOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
