...
import (
	...
	"github.com/hashicorp/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v3/s3bucketobject/internal"
...
func (j *jsiiProxy_S3BucketObject) SseKmsKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sseKmsKeyId",
...
func (j *jsiiProxy_S3BucketObject) SseKmsKeyIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sseKmsKeyIdInput",
...
func (s *jsiiProxy_S3BucketObject) ResetSseKmsKeyId() {
	_jsii_.InvokeVoid(
		s,
		"resetSseKmsKeyId",
		nil, // no parameters
