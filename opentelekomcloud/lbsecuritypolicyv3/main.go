...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LbSecurityPolicyV3)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "listenerIds", GoGetter: "ListenerIds"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LbSecurityPolicyV3Config)(nil)).Elem(),
	)
}
