...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WafDedicatedInstanceV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "billingStatus", GoGetter: "BillingStatus"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetResTenant", GoMethod: "ResetResTenant"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "resTenant", GoGetter: "ResTenant"},
			_jsii_.MemberProperty{JsiiProperty: "resTenantInput", GoGetter: "ResTenantInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "serviceIp", GoGetter: "ServiceIp"},
			...
			_jsii_.MemberProperty{JsiiProperty: "upgradable", GoGetter: "Upgradable"},
