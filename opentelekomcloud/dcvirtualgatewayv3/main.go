...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DcVirtualGatewayV3)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "localEpGroupIpv6", GoGetter: "LocalEpGroupIpv6"},
			_jsii_.MemberProperty{JsiiProperty: "localEpGroupIpv6Input", GoGetter: "LocalEpGroupIpv6Input"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLocalEpGroupIpv6", GoMethod: "ResetLocalEpGroupIpv6"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DcVirtualGatewayV3Config)(nil)).Elem(),
	)
}
