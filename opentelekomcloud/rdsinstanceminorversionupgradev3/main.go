...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsInstanceMinorVersionUpgradeV3)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.rdsInstanceMinorVersionUpgradeV3.RdsInstanceMinorVersionUpgradeV3Config",
		reflect.TypeOf((*RdsInstanceMinorVersionUpgradeV3Config)(nil)).Elem(),
	)
}
