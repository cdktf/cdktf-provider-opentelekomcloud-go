...
func (a *jsiiProxy_AsmServiceMeshV1ProxyConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AsmServiceMeshV1ProxyConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
