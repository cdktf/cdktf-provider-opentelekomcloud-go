...
import (
	...
	"github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v4/dataopentelekomclouddmsmaintainwindowv1/internal"
...
func (j *jsiiProxy_DataOpentelekomcloudDmsMaintainwindowV1) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
