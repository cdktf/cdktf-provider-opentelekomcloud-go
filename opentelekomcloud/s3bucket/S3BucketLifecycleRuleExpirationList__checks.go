...
func (s *jsiiProxy_S3BucketLifecycleRuleExpirationList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_S3BucketLifecycleRuleExpirationList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
