...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WafAlarmNotificationV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "sendFrequency", GoGetter: "SendFrequency"},
			_jsii_.MemberProperty{JsiiProperty: "sendFrequencyInput", GoGetter: "SendFrequencyInput"},
			_jsii_.MemberMethod{JsiiMethod: "synthesizeAttributes", GoMethod: "SynthesizeAttributes"},
			_jsii_.MemberProperty{JsiiProperty: "terraformGeneratorMetadata", GoGetter: "TerraformGeneratorMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "terraformMetaArguments", GoGetter: "TerraformMetaArguments"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResourceType", GoGetter: "TerraformResourceType"},
			_jsii_.MemberProperty{JsiiProperty: "threat", GoGetter: "Threat"},
			_jsii_.MemberProperty{JsiiProperty: "threatInput", GoGetter: "ThreatInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WafAlarmNotificationV1Config)(nil)).Elem(),
	)
}
