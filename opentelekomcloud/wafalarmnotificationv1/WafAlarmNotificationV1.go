...
import (
	...
	"github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v11/wafalarmnotificationv1/internal"
...
// Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.23/docs/resources/waf_alarm_notification_v1 opentelekomcloud_waf_alarm_notification_v1} Resource.
...
func WafAlarmNotificationV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafAlarmNotificationV1_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WafAlarmNotificationV1) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafAlarmNotificationV1) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafAlarmNotificationV1) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafAlarmNotificationV1) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafAlarmNotificationV1) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WafAlarmNotificationV1) MoveToId(id *string) {
...
func (w *jsiiProxy_WafAlarmNotificationV1) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafAlarmNotificationV1) ToHclTerraform() interface{} {
	var returns interface{}
