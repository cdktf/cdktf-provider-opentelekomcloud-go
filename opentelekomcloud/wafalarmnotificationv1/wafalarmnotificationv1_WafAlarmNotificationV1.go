...
import (
	...
	"github.com/hashicorp/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v3/wafalarmnotificationv1/internal"
...
func (j *jsiiProxy_WafAlarmNotificationV1) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
