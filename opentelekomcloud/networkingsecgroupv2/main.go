...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkingSecgroupV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "deleteDefaultRules", GoGetter: "DeleteDefaultRules"},
			_jsii_.MemberProperty{JsiiProperty: "deleteDefaultRulesInput", GoGetter: "DeleteDefaultRulesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDeleteDefaultRules", GoMethod: "ResetDeleteDefaultRules"},
