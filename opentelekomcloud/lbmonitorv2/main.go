...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LbMonitorV2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LbMonitorV2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.lbMonitorV2.LbMonitorV2Timeouts",
		reflect.TypeOf((*LbMonitorV2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.lbMonitorV2.LbMonitorV2TimeoutsOutputReference",
		reflect.TypeOf((*LbMonitorV2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
