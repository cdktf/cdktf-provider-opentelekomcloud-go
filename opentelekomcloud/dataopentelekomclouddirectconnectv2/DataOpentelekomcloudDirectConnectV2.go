...
import (
	...
	"github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v11/dataopentelekomclouddirectconnectv2/internal"
...
func (d *jsiiProxy_DataOpentelekomcloudDirectConnectV2) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataOpentelekomcloudDirectConnectV2) ToHclTerraform() interface{} {
	var returns interface{}
