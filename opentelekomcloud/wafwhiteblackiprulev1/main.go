...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WafWhiteblackipRuleV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetWhite", GoMethod: "ResetWhite"},
			...
			_jsii_.MemberProperty{JsiiProperty: "white", GoGetter: "White"},
			_jsii_.MemberProperty{JsiiProperty: "whiteInput", GoGetter: "WhiteInput"},
		},
		func() interface{} {
