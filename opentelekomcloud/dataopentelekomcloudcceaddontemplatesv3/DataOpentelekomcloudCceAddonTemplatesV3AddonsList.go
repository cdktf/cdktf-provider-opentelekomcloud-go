...
func (d *jsiiProxy_DataOpentelekomcloudCceAddonTemplatesV3AddonsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataOpentelekomcloudCceAddonTemplatesV3AddonsList) Resolve(context cdktf.IResolveContext) interface{} {
