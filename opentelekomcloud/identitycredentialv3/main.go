...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IdentityCredentialV3)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lastUseTime", GoGetter: "LastUseTime"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*IdentityCredentialV3Config)(nil)).Elem(),
	)
}
