...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RtsSoftwareDeploymentV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "outputValuesInput", GoGetter: "OutputValuesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOutputValues", GoMethod: "ResetOutputValues"},
