...
func (d *jsiiProxy_DmsUserPermissionV1PoliciesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DmsUserPermissionV1PoliciesList) Resolve(context cdktf.IResolveContext) interface{} {
