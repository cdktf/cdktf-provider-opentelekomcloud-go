...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LbPolicyV3)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putRedirectPoolsConfig", GoMethod: "PutRedirectPoolsConfig"},
			_jsii_.MemberMethod{JsiiMethod: "putRedirectUrlConfig", GoMethod: "PutRedirectUrlConfig"},
			_jsii_.MemberMethod{JsiiMethod: "putRules", GoMethod: "PutRules"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberProperty{JsiiProperty: "redirectListenerId", GoGetter: "RedirectListenerId"},
			_jsii_.MemberProperty{JsiiProperty: "redirectListenerIdInput", GoGetter: "RedirectListenerIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "redirectPoolId", GoGetter: "RedirectPoolId"},
			_jsii_.MemberProperty{JsiiProperty: "redirectPoolIdInput", GoGetter: "RedirectPoolIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "redirectPoolsConfig", GoGetter: "RedirectPoolsConfig"},
			_jsii_.MemberProperty{JsiiProperty: "redirectPoolsConfigInput", GoGetter: "RedirectPoolsConfigInput"},
			_jsii_.MemberProperty{JsiiProperty: "redirectUrl", GoGetter: "RedirectUrl"},
			_jsii_.MemberProperty{JsiiProperty: "redirectUrlConfig", GoGetter: "RedirectUrlConfig"},
			_jsii_.MemberProperty{JsiiProperty: "redirectUrlConfigInput", GoGetter: "RedirectUrlConfigInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRedirectListenerId", GoMethod: "ResetRedirectListenerId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRedirectPoolId", GoMethod: "ResetRedirectPoolId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRedirectPoolsConfig", GoMethod: "ResetRedirectPoolsConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetRedirectUrl", GoMethod: "ResetRedirectUrl"},
			_jsii_.MemberMethod{JsiiMethod: "resetRedirectUrlConfig", GoMethod: "ResetRedirectUrlConfig"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LbPolicyV3Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.lbPolicyV3.LbPolicyV3FixedResponseConfig",
		reflect.TypeOf((*LbPolicyV3FixedResponseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.lbPolicyV3.LbPolicyV3FixedResponseConfigOutputReference",
		reflect.TypeOf((*LbPolicyV3FixedResponseConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LbPolicyV3RedirectPoolsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.lbPolicyV3.LbPolicyV3RedirectPoolsConfigList",
		reflect.TypeOf((*LbPolicyV3RedirectPoolsConfigList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LbPolicyV3RedirectPoolsConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LbPolicyV3RedirectUrlConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.lbPolicyV3.LbPolicyV3RedirectUrlConfigOutputReference",
		reflect.TypeOf((*LbPolicyV3RedirectUrlConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LbPolicyV3Rules)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.lbPolicyV3.LbPolicyV3RulesList",
		reflect.TypeOf((*LbPolicyV3RulesList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
		...
		func() interface{} {
			j := jsiiProxy_LbPolicyV3RulesList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LbPolicyV3RulesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "compareType", GoGetter: "CompareType"},
			_jsii_.MemberProperty{JsiiProperty: "compareTypeInput", GoGetter: "CompareTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
