...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudCceNodeV3)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudCceNodeV3DataVolumesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
