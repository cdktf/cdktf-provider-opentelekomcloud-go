...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudVpcepPublicServiceV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isCharge", GoGetter: "IsCharge"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataOpentelekomcloudVpcepPublicServiceV1Config)(nil)).Elem(),
	)
}
