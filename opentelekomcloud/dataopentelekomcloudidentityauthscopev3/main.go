...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudIdentityAuthScopeV3)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "projectDomainId", GoGetter: "ProjectDomainId"},
			_jsii_.MemberProperty{JsiiProperty: "projectDomainName", GoGetter: "ProjectDomainName"},
			...
			_jsii_.MemberProperty{JsiiProperty: "userDomainId", GoGetter: "UserDomainId"},
			_jsii_.MemberProperty{JsiiProperty: "userDomainName", GoGetter: "UserDomainName"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudIdentityAuthScopeV3RolesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
