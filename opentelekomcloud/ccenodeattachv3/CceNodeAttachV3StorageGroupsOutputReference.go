...
func (c *jsiiProxy_CceNodeAttachV3StorageGroupsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CceNodeAttachV3StorageGroupsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
