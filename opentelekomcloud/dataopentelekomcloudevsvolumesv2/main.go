...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudEvsVolumesV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetShareable", GoMethod: "ResetShareable"},
			_jsii_.MemberMethod{JsiiMethod: "resetStatus", GoMethod: "ResetStatus"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetVolumeId", GoMethod: "ResetVolumeId"},
			_jsii_.MemberMethod{JsiiMethod: "resetVolumeTypeId", GoMethod: "ResetVolumeTypeId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "shareable", GoGetter: "Shareable"},
			_jsii_.MemberProperty{JsiiProperty: "shareableInput", GoGetter: "ShareableInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "volumeTypeId", GoGetter: "VolumeTypeId"},
			_jsii_.MemberProperty{JsiiProperty: "volumeTypeIdInput", GoGetter: "VolumeTypeIdInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudEvsVolumesV2VolumesAttachmentsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "attachedAt", GoGetter: "AttachedAt"},
			_jsii_.MemberProperty{JsiiProperty: "attachedMode", GoGetter: "AttachedMode"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudEvsVolumesV2VolumesList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudEvsVolumesV2VolumesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
