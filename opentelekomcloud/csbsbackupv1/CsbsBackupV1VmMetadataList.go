...
func (c *jsiiProxy_CsbsBackupV1VmMetadataList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CsbsBackupV1VmMetadataList) Resolve(context cdktf.IResolveContext) interface{} {
