...
func (d *jsiiProxy_DataOpentelekomcloudLbLoadbalancerV3PublicIpList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataOpentelekomcloudLbLoadbalancerV3PublicIpList) Resolve(context cdktf.IResolveContext) interface{} {
