...
func (a *jsiiProxy_ApigwVpcChannelV2HealthCheckOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApigwVpcChannelV2HealthCheckOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
