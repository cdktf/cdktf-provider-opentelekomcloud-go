...
func (a *jsiiProxy_ApigwVpcChannelV2MemberGroupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApigwVpcChannelV2MemberGroupOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
