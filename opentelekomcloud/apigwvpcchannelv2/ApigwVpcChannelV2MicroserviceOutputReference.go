...
func (a *jsiiProxy_ApigwVpcChannelV2MicroserviceOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApigwVpcChannelV2MicroserviceOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
