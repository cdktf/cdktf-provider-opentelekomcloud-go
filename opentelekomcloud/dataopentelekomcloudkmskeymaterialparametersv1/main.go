...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudKmsKeyMaterialParametersV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "importToken", GoGetter: "ImportToken"},
			...
			_jsii_.MemberProperty{JsiiProperty: "wrappingAlgorithm", GoGetter: "WrappingAlgorithm"},
			_jsii_.MemberProperty{JsiiProperty: "wrappingAlgorithmInput", GoGetter: "WrappingAlgorithmInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataOpentelekomcloudKmsKeyMaterialParametersV1Config)(nil)).Elem(),
	)
}
