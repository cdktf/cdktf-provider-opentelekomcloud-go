...
func (i *jsiiProxy_IdentityRoleV3StatementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IdentityRoleV3StatementOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
