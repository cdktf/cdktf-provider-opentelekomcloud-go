...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IdentityRoleV3)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "displayLayer", GoGetter: "DisplayLayer"},
			_jsii_.MemberProperty{JsiiProperty: "displayLayerInput", GoGetter: "DisplayLayerInput"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IdentityRoleV3StatementOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
