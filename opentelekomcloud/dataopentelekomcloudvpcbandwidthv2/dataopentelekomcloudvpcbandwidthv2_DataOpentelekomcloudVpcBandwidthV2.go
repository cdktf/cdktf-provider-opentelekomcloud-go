...
import (
	...
	"github.com/hashicorp/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v3/dataopentelekomcloudvpcbandwidthv2/internal"
...
func (j *jsiiProxy_DataOpentelekomcloudVpcBandwidthV2) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
