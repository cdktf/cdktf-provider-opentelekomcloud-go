...
import (
	...
	"github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v4/dataopentelekomcloudcceaddontemplatev3/internal"
...
func (j *jsiiProxy_DataOpentelekomcloudCceAddonTemplateV3) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataOpentelekomcloudCceAddonTemplateV3)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
