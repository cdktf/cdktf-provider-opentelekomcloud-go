...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudTaurusdbMysqlSlowLogsV3)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "slowLogList", GoGetter: "SlowLogList"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.dataOpentelekomcloudTaurusdbMysqlSlowLogsV3.DataOpentelekomcloudTaurusdbMysqlSlowLogsV3Config",
		reflect.TypeOf((*DataOpentelekomcloudTaurusdbMysqlSlowLogsV3Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.dataOpentelekomcloudTaurusdbMysqlSlowLogsV3.DataOpentelekomcloudTaurusdbMysqlSlowLogsV3SlowLogListStruct",
		reflect.TypeOf((*DataOpentelekomcloudTaurusdbMysqlSlowLogsV3SlowLogListStruct)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudTaurusdbMysqlSlowLogsV3SlowLogListStructList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudTaurusdbMysqlSlowLogsV3SlowLogListStructOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nodeId", GoGetter: "NodeId"},
			_jsii_.MemberProperty{JsiiProperty: "querySample", GoGetter: "QuerySample"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "rowsExamined", GoGetter: "RowsExamined"},
			_jsii_.MemberProperty{JsiiProperty: "rowsSent", GoGetter: "RowsSent"},
