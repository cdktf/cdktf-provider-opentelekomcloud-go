...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DisCheckpointV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "sequenceNumberInput", GoGetter: "SequenceNumberInput"},
