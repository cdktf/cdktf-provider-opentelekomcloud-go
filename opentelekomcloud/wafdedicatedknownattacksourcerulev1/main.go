...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WafDedicatedKnownAttackSourceRuleV1)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "blockTime", GoGetter: "BlockTime"},
			_jsii_.MemberProperty{JsiiProperty: "blockTimeInput", GoGetter: "BlockTimeInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WafDedicatedKnownAttackSourceRuleV1Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.wafDedicatedKnownAttackSourceRuleV1.WafDedicatedKnownAttackSourceRuleV1Timeouts",
		reflect.TypeOf((*WafDedicatedKnownAttackSourceRuleV1Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WafDedicatedKnownAttackSourceRuleV1TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
