...
func (l *jsiiProxy_LtsKeywordsAlarmRuleV2NotificationRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LtsKeywordsAlarmRuleV2NotificationRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
