...
func (l *jsiiProxy_LtsKeywordsAlarmRuleV2KeywordsRequestsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LtsKeywordsAlarmRuleV2KeywordsRequestsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
