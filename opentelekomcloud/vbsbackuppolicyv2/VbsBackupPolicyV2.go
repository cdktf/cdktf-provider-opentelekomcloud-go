...
// Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.14/docs/resources/vbs_backup_policy_v2 opentelekomcloud_vbs_backup_policy_v2} Resource.
...
func VbsBackupPolicyV2_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateVbsBackupPolicyV2_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VbsBackupPolicyV2) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VbsBackupPolicyV2) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VbsBackupPolicyV2) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (v *jsiiProxy_VbsBackupPolicyV2) MoveFromId(id *string) {
...
func (v *jsiiProxy_VbsBackupPolicyV2) MoveTo(moveTarget *string, index interface{}) {
...
func (v *jsiiProxy_VbsBackupPolicyV2) MoveToId(id *string) {
...
func (v *jsiiProxy_VbsBackupPolicyV2) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VbsBackupPolicyV2) ToHclTerraform() interface{} {
	var returns interface{}
