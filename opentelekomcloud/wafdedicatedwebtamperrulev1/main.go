...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WafDedicatedWebTamperRuleV1)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUpdateCache", GoMethod: "ResetUpdateCache"},
			...
			_jsii_.MemberProperty{JsiiProperty: "updateCache", GoGetter: "UpdateCache"},
			_jsii_.MemberProperty{JsiiProperty: "updateCacheInput", GoGetter: "UpdateCacheInput"},
