...
import (
	...
	"github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v12/dataopentelekomcloudctstrackerv1/internal"
...
func (j *jsiiProxy_DataOpentelekomcloudCtsTrackerV1) Count() interface{} {
...
func NewDataOpentelekomcloudCtsTrackerV1(scope constructs.Construct, id *string, config *DataOpentelekomcloudCtsTrackerV1Config) DataOpentelekomcloudCtsTrackerV1 {
	...
	if err := validateNewDataOpentelekomcloudCtsTrackerV1Parameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataOpentelekomcloudCtsTrackerV1)SetCount(val interface{}) {
...
func DataOpentelekomcloudCtsTrackerV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataOpentelekomcloudCtsTrackerV1_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataOpentelekomcloudCtsTrackerV1_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataOpentelekomcloudCtsTrackerV1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataOpentelekomcloudCtsTrackerV1_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataOpentelekomcloudCtsTrackerV1_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataOpentelekomcloudCtsTrackerV1_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataOpentelekomcloudCtsTrackerV1_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataOpentelekomcloudCtsTrackerV1) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataOpentelekomcloudCtsTrackerV1) ToHclTerraform() interface{} {
	var returns interface{}
