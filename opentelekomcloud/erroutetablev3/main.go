...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ErRouteTableV3)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isDefaultAssociation", GoGetter: "IsDefaultAssociation"},
			_jsii_.MemberProperty{JsiiProperty: "isDefaultPropagation", GoGetter: "IsDefaultPropagation"},
