...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SfsShareAccessRulesV2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SfsShareAccessRulesV2AccessRule)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.sfsShareAccessRulesV2.SfsShareAccessRulesV2AccessRuleList",
		reflect.TypeOf((*SfsShareAccessRulesV2AccessRuleList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SfsShareAccessRulesV2AccessRuleOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SfsShareAccessRulesV2Config)(nil)).Elem(),
	)
}
