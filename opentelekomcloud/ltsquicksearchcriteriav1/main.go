...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LtsQuickSearchCriteriaV1)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.ltsQuickSearchCriteriaV1.LtsQuickSearchCriteriaV1Config",
		reflect.TypeOf((*LtsQuickSearchCriteriaV1Config)(nil)).Elem(),
	)
}
