...
func (c *jsiiProxy_CssClusterV1PublicAccessOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CssClusterV1PublicAccessOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
