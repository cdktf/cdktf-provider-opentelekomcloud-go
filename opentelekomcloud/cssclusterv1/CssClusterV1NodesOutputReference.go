...
func (c *jsiiProxy_CssClusterV1NodesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CssClusterV1NodesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
