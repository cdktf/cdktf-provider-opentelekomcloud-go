...
func (j *jsiiProxy_DataOpentelekomcloudCsbsBackupPolicyV1) Count() interface{} {
...
func NewDataOpentelekomcloudCsbsBackupPolicyV1(scope constructs.Construct, id *string, config *DataOpentelekomcloudCsbsBackupPolicyV1Config) DataOpentelekomcloudCsbsBackupPolicyV1 {
	...
	if err := validateNewDataOpentelekomcloudCsbsBackupPolicyV1Parameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataOpentelekomcloudCsbsBackupPolicyV1)SetCount(val interface{}) {
...
func DataOpentelekomcloudCsbsBackupPolicyV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataOpentelekomcloudCsbsBackupPolicyV1_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataOpentelekomcloudCsbsBackupPolicyV1_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataOpentelekomcloudCsbsBackupPolicyV1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataOpentelekomcloudCsbsBackupPolicyV1_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataOpentelekomcloudCsbsBackupPolicyV1_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataOpentelekomcloudCsbsBackupPolicyV1_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataOpentelekomcloudCsbsBackupPolicyV1_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataOpentelekomcloudCsbsBackupPolicyV1) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataOpentelekomcloudCsbsBackupPolicyV1) ToHclTerraform() interface{} {
	var returns interface{}
