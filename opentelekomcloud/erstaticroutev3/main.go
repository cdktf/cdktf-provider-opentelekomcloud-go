...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ErStaticRouteV3)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isBlackhole", GoGetter: "IsBlackhole"},
			_jsii_.MemberProperty{JsiiProperty: "isBlackholeInput", GoGetter: "IsBlackholeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsBlackhole", GoMethod: "ResetIsBlackhole"},
