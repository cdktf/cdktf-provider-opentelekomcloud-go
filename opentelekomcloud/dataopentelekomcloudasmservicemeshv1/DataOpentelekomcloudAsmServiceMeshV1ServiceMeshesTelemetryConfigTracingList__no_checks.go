...
func (d *jsiiProxy_DataOpentelekomcloudAsmServiceMeshV1ServiceMeshesTelemetryConfigTracingList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
