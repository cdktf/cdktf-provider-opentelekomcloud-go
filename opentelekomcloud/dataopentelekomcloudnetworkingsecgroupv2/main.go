...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOpentelekomcloudNetworkingSecgroupV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSecgroupId", GoMethod: "ResetSecgroupId"},
			_jsii_.MemberMethod{JsiiMethod: "resetTenantId", GoMethod: "ResetTenantId"},
			_jsii_.MemberProperty{JsiiProperty: "secgroupId", GoGetter: "SecgroupId"},
			_jsii_.MemberProperty{JsiiProperty: "secgroupIdInput", GoGetter: "SecgroupIdInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataOpentelekomcloudNetworkingSecgroupV2Config)(nil)).Elem(),
	)
}
