...
import (
	...
	"github.com/cdktf/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v12/vpcbandwidthassociatev2/internal"
...
func (v *jsiiProxy_VpcBandwidthAssociateV2) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VpcBandwidthAssociateV2) ToHclTerraform() interface{} {
	var returns interface{}
