...
import (
	...
	"github.com/hashicorp/cdktf-provider-opentelekomcloud-go/opentelekomcloud/v3/dataopentelekomcloudlbmemberidsv2/internal"
...
func (j *jsiiProxy_DataOpentelekomcloudLbMemberIdsV2) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataOpentelekomcloudLbMemberIdsV2)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
