...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FgsTriggerV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "eventData", GoGetter: "EventData"},
			_jsii_.MemberProperty{JsiiProperty: "eventDataInput", GoGetter: "EventDataInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*FgsTriggerV2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-opentelekomcloud.fgsTriggerV2.FgsTriggerV2Timeouts",
		reflect.TypeOf((*FgsTriggerV2Timeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-opentelekomcloud.fgsTriggerV2.FgsTriggerV2TimeoutsOutputReference",
		reflect.TypeOf((*FgsTriggerV2TimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
