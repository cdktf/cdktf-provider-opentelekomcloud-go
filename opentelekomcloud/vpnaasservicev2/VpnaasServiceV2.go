...
func (j *jsiiProxy_VpnaasServiceV2) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func NewVpnaasServiceV2(scope constructs.Construct, id *string, config *VpnaasServiceV2Config) VpnaasServiceV2 {
	...
	if err := validateNewVpnaasServiceV2Parameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_VpnaasServiceV2)SetCount(val interface{}) {
...
func VpnaasServiceV2_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateVpnaasServiceV2_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func VpnaasServiceV2_IsConstruct(x interface{}) *bool {
	...
	if err := validateVpnaasServiceV2_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VpnaasServiceV2_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVpnaasServiceV2_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VpnaasServiceV2_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVpnaasServiceV2_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (v *jsiiProxy_VpnaasServiceV2) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VpnaasServiceV2) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VpnaasServiceV2) ToHclTerraform() interface{} {
	var returns interface{}
