...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VpnaasServiceV2)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "externalV4Ip", GoGetter: "ExternalV4Ip"},
			_jsii_.MemberProperty{JsiiProperty: "externalV6Ip", GoGetter: "ExternalV6Ip"},
